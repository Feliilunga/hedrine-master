<div id="myModal-targetEditing" class="modal fade" role="dialog">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-2 text-gray-dark" for="herbname">Herb Name:</label>
                        <div class="col-sm-10">
                            <input type="text" style="border: 0;border-bottom: 1px solid gray"  class="form-control" id="herbname">
                        </div>
                        <label class="control-label col-sm-4 text-gray-dark" for="targetname">Target Name:</label>
                        <div class="col-sm-10">
                            <input type="text" style="border: 0;border-bottom: 1px solid gray"  class="form-control" id="targetname">
                        </div>
