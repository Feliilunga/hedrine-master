<div id="myModal-hinteractionTargetEdit" class="modal fade" role="dialog">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-4 text-gray-dark" for="herbname">Herb Name:</label>
                        <div class="col-sm-10">
                            <input type="text" style="border: 0;border-bottom: 1px solid gray"  class="form-control" id="herbname" disabled>
                        </div>
...
<div class="route">
    <input type="hidden" id="quick-edit-url" value="{{route('admin.hinteractiontargetEdit')}}">
</div>
