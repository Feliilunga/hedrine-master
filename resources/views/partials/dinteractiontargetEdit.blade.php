<div id="myModal-dinteractionTargetEdit" class="modal fade" role="dialog">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-4 text-gray-dark" for="drugname">Drug Name:</label>
                        <div class="col-sm-10">
                            <input type="text" style="border: 0;border-bottom: 1px solid gray"  class="form-control" id="drugname" disabled>
                        </div>
                        <label class="control-label col-sm-6 text-gray-dark" for="targetname">Target Name:</label>
                        <div class="col-sm-10">
                            <input type="text" style="border: 0;border-bottom: 1px solid gray"  class="form-control" id="targetname" disabled>
                        </div>
                        <label class="control-label col-sm-2 text-gray-dark" for="notes">Notes:</label>
                        <div class="col-sm-12">
                            <textarea type="text" style="border: 0;border-bottom: 1px solid gray"  class="form-control" id="notes" rows="5"></textarea>
                        </div>
                    </div>
...
<div class="route">
    <input type="hidden" id="quick-edit-url" value="{{route('admin.dinteractiontargetEdit')}}">
</div>
