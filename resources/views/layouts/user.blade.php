    ...
    <div class="sidebar">
       ...
       <nav class="mt-2 sidebar-nav">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item @if(request()->route()->getName() == 'userprofile.index') active @endif">
                    <a class="nav-link active " href="{{ route('userprofile.index') }}" style="background-color:green;">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item @if(request()->route()->getName() == 'userprofile.attente') active @endif">
                            <a href="{{ route('userprofile.attente')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>En attente</p>
                            </a>
                        </li>
                        <li class="nav-item  @if(request()->route()->getName() == 'userprofile.validated') active @endif ">
                            <a href="{{route('userprofile.validated')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Active</p>
                            </a>
                        </li>
                        <li class="nav-item  @if(request()->route()->getName() == 'userprofile.modifier') active @endif ">
                ...
                <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('userprofile.attente_dci')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>En attente</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('userprofile.validated_dci')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Active</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('userprofile.modifier_dci')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Modifier</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('userprofile.attente_target')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>En attente</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('userprofile.validated_target')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Active</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('userprofile.modifier_target')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Modifier</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('userprofile.attente_hinteraction')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>En attente</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('userprofile.validated_hinteraction')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Active</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('userprofile.modifier_hinteraction')}}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Modifier</p>
                            </a>
                        </li>
