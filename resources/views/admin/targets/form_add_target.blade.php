							...
							<form class=" justify-content-center" role="form" method="POST" action="@isset($target) {{ route('target.update', $target->id) }} @else {{
								...
								<div class="card-body">
									...
									<div class="form-group">
										...
										<textarea rows="10" cols="15" class="form-control" id="notes" name="notes" placeholder="Veuillez introduire une note pour la target" >{{ isset($target) ? $target->notes : ''}}</textarea>
									</div>
									<div class="form-group">
