            ...
            <div class="card">
                ...
                <div class="card-title">
                    <h3> Nous estimons qu il manque quelques précisions sur les points ci-dessus :
                        (<small>Veuillez corriger les erreurs et soumettre votre target à nouveau</small>)
                    </h3>
                </div>
                <div class="card-body">
                    <hr>
                    <blockquote class="blockquote">
                        ...
                        <div>
                            <a href="route('target.show', $target->id)" class="btn btn-success btn-lg active" role="button" aria-pressed="true">Voir cette plante ({{ $target->name }})</a>
                        </div>
                    </blockquote>
                    <hr>
