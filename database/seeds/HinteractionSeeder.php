...
class HinteractionSeeder extends Seeder
{
    ...
    'target_id'=>10,
    'force_id'=>2,
    'notes'=>'Les résultats de cette étude ont montré que la glucuronidation de la testostérone via l\'UGT2B17 a été inhibée par les extraits de thé vert et de blanc, et notamment par l\'épicatéchine, l\'épigallocatéchine gallate (EGCG) et la catéchine gallate. La valeur IC50 d\'inhibition de l\'EGCG a été évaluée à 64 uM, soit de l\'ordre du diclofénac. \r\nLes EGCG ont également montré une activité sur l\'UGT1A4, sur des microsome de foie humain',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Hinteraction::create( [
        ...
        Hinteraction::create( [
            ...
            'target_id'=>36,
            'force_id'=>3,
            'notes'=>'3 case report :\r\n- Millonig décrit le cas d\'un patient de 45 ans, admis pour malaise, douleurs thoraciques, nausées, manque d’appétit, fatigue…\r\nLes paramètres hépatiques étaient élevés.\r\nIl prenait un verre de Noni depuis plusieurs semaines.\r\nLa biospsie hépatique a révélé une hépatite aiguë avec infiltrat inflammatoire mixte et une cholestase hépatocellulaire.\r\nIl a arrêté de boire du Noni et 2j après, les transaminases avaient baissé.\r\n- Stadlbauer décrit le cas de 2 patients ayant consommé du Noni dont 1 qui a nécessité une transplantation.\r\n- Yuce décrit le cas d\'une patiente de 24 ans, admise pour jaunisse et transaminases élevées.\r\nElle prenait de l’INF pour une sclérose multiple ; ce traitement a été arrêté car ce traitement pouvait être la cause de l\'hépatotoxicité. Mais une semaine après l’arrêt, les enzymes hépatiques grimpaient encore.\r\nL\'interrogatoire a permis de mettre en évidence la prise de jus de Noni depuis 4 semaines.\r\nA l’arrêt du Noni, les transaminases ont chuté.\r\n\r\n',
            'user_id'=>2,
            'validated'=>1
            ] );
            ...
            'target_id'=>36,
            'force_id'=>3,
            'notes'=>'La chélidoine a été impliquée dans plus d\'une douzaine de cas d\'hépatite impliquant cinq produits de marques différentes, fabriqués en Allemagne.\r\n3 case report (Stickel, 2003 ; Moro, 2009) :\r\n- 2 cas décrits par Stickel : élévation des enzymes hépatiques suite à la consommation de chélidoine et présence de symptômes (jaunisse, urines sombres...). Récupération de la fonction hépatique à l\'arrêt.\r\n- 1 cas décrit par Moro : patient de 65 ans, admis pour asthénie, dyspepsie et jaunisse. Il consommait de la chélidoine.',
            'user_id'=>2,
            'validated'=>1
            ] );
    ...
    Hinteraction::create( [
        ...
        Hinteraction::create( [
            ...
            'target_id'=>9,
            'force_id'=>5,
            'notes'=>'In vitro, l’extrait hydroalcoolique de la feuille du ginkgo  (flavonoides) à une concentration (120µg/ml) pouvant être atteinte dans l’intestin humain, inhiberait  de manière concentration dépendante la prise de l’estrone-3 –sulfate par le OATP-B  de 85.4% (p<0.01), considéré comme étant un puissant effet (IC50 = 11.2 +/- 3.3 µg/ml). OATP-B est connu pour jouer un rôle dans l’absorption de certains médicaments donc son inhibition pourrait diminuer leur absorption. \r\nLors d\'une étude clinique sur 24 sujets sains, pas d\'interaction clinique entre la ticlopidine (un substrat de l\'OATP) en le ginkgo ',
            'user_id'=>2,
            'validated'=>1
            ] );
    ...
    'target_id'=>3,
    'force_id'=>5,
    'notes'=>'Les résultats sont controversés.\r\nL\'extrait standardisé EGb 761 inhibe le CYP2C9 in vitro. Les terpénoides (ginkgolides) et les flavonoides (quercetin, kaempferol, etc) semblent responsable de cette activité.\r\nL\'étude in vitro de Gaudineau a montré que l\'extrait EGb761 inhibait fortement le CYP2C9.\r\nPar contre, l\'activité n\'a pas été retrouvée cliniquement et n\'affecte pas la métabolisation du diclofénac ou de la tolbutamide (substrats CYP2C9). ',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>1,
    'force_id'=>3,
    'notes'=>'Des études in vitro montrent que les feuilles de gingko ont un effet inhibiteur sur le CYP1A2 d\'environ 13%\r\nL\'étude in vitro de Gaudineau montre que ce sont les flavonoïdes qui sont responsables de cette inhibition.\r\nLes études cliniques montrent que l\'effet n\'est pas significatif in vivo.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>7,
    'force_id'=>4,
    'notes'=>'Les flavonoides (quercetine, kaempferol, myricetine, etc) sont inhibiteurs du CYP2E1 in vitro.\r\nPas interaction in vivo.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'En 2001, 30 cas d\'hépatotoxicité déclarés par les autorités allemande et suisse.\r\nUn cas a été mortel et 4 ou 5 ont nécessité une transplantation.\r\nEn Juillet 2002, les autorités anglaises rapportent 68 cas d\'hépatotoxicité de part le monde.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>4,
    'notes'=>'Etude sur 16 sujets sains recevant  du Kava Kava en association avec du midazolam (substrat du CYP3A4).\r\nComparaison avec la rifampicine (inducteur du CYP3A4) et la clarithromycine (inhibiteur du CYP3A4).\r\nPas de modifications des paramètres pharmacocinétiques du midazolam. \r\n',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>21,
    'force_id'=>3,
    'notes'=>'Les polysaccharides et ginsénosides immunomodulants (dans l\'étude menée par Beckert) sont susceptibles d\'intéragir avec les anticorps monoclonaux (D1-D6). Le panax ginseng stimule l\'activité des cellules NK.\r\nMais il n\'y a pas d\'argument pour penser qu\'il y ait une interaction avec les cytotoxiques autres que ceux ayant une structure d\'anticorps.\r\n',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Hinteraction::create( [
        ...
        'target_id'=>2,
        'force_id'=>5,
        'notes'=>'Des études cliniques contradictoires suggèrent que le chardon-marie doit ou pas provoquer des interactions au niveau clinique avec les substrats du CYP3A4 chez l\'homme. \r\nLes études pharmacocinétiques avec 200 mg 3 fois par jour de chardon-marie montrent que le profil de l\'irinotecan (substrat du CYP3A4) n\'est pas affecté significativement ',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>9,
        'force_id'=>2,
        'notes'=>'Inhibition OATP1A2 via la Naringine. \r\nBoire de grandes quantités de jus d\'orange soit 200 mL trois fois par jour, diminue les quantités de céliprolol (substrat de OATP) de 80% à 90%\r\n\r\nL\'activité inhibitrice de OATP2B1 a aussi été décrite',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            'target_id'=>8,
            'force_id'=>1,
            'notes'=>'Le millepertuis semble induire l’expression de la glycoprotéine P, dans plusieurs études cliniques sur des volontaires sains. Il semble que cette interaction soit également due à la présence d’hyperforine. \r\nDe même, il apparaît que le millepertuis diminue les concentrations plasmatiques de substrats connus de la PGP dont la digoxine et la fexofenadine \r\nLes effets du millepertuis sur la PGP sont en général observés après les traitements de longue durée (10 jours ou plus) et semblent comparables dans les différentes ethnies (africains, caucasiens, hispaniques, indiens…)\r\nUne seule dose de 900 mg d\'extrait induit une inhibition significative de la p-gp intestinale\r\n',
            'user_id'=>2,
            'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            'target_id'=>2,
            'force_id'=>1,
            'notes'=>'Démontré sur culture d\'hépatocyte humain et sur sujets\r\nIl semble aussi in vitro que le millepertuis soit inducteur du 3A4 à faible dose et inhibiteur à grande concentration',
            'user_id'=>2,
            'validated'=>1
            ] );
            ...
            'target_id'=>22,
            'force_id'=>1,
            'notes'=>'Une étude chez 12 sujets sains recevant  de l\'imatinib de manière concomitante (400mg par jour aux jours 1 et 15) au millepertuis (900 mg par jour les jours 4 à 17) a montré qu\'il y avait une diminution des concentrations plasmatiques d\'imatinib de 30%.\r\n\r\ncette interaction est probablement due au millepertuis en tant que inducteur du cytochrome P450 3A4\r\n',
            'user_id'=>2,
            'validated'=>1
            ] );
    ...
    'target_id'=>9,
    'force_id'=>5,
    'notes'=>'L\'expression de OATP1A2 n\'est pas affecté quand la prise de pomélo est ponctuelle. Mais la recherche in vitro et clinique montre que le jus de pomélo inhibe la consommation d\'anions organiques (OATP transport polypeptides), ce qui réduit la biodisponibilité des médicaments par voie orale qui sont des substrats de OATP\r\nUne étude sur le rat démontre que la 6\',7\'-dihydroxybergamottin inhibe oatp1 et 3 (IC(50), 0.28 micromol/L).\r\n\r\nL\'activité inhibitrice de OATP2B1 a aussi été décrite.',
    'user_id'=>2,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    Hinteraction::create( [
        ...
        'target_id'=>72,
        'force_id'=>1,
        'notes'=>'La recherche clinique montre que la prise d\'un extrait aqueux de café vert peut réduire significativement la pression artérielle chez les personnes souffrant d\'hypertension. Dans un essai clinique, après la prise d\'un extrait standardisé (93 mg ou 185 mg/j pendant 28 jours) chez des patients souffrant d\'hypertension légère, la pression artérielle systolique a été diminuée d\'environ 5-6 mm Hg et la pression diastolique de 3-4 dans mmHg.\r\n\r\nDans un autre essai clinique, l\'étude a été réalisée en utilisant les acides chlorogéniques, extrait de café vert 140 mg par jour sur une période courte contre placebo, pour démontrer cette activité',
        'user_id'=>2,
        'validated'=>1
        ] );
...
'validated'=>1
    ...
    Hinteraction::create( [
        ...
        'target_id'=>5,
        'force_id'=>4,
        'notes'=>'les études cliniques utilisant le dextrométhorphane comme substrat témoin de\r\nl’activité du CYP2D6 ne montrent pas d’effet significatif (6 études cliniques)',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            'target_id'=>7,
            'force_id'=>2,
            'notes'=>'Des études cliniques utilisant le chloroxazone comme substrat témoin de l’activité du 2E1 montrent une diminution de la conversion de chloroxazone en son métabolite (6-hydroxychloroxazone). \r\nDes études cliniques montrent que l\'huile d\'ail inhibe l\'activité du CYP2E1 de 39%.\r\nDe plus, 6 études cliniques ont montré que la diallyl sulfone était un inhibiteur suicide in vivo\r\n',
            'user_id'=>2,
            'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            'target_id'=>8,
            'force_id'=>5,
            'notes'=>'inducteur ou inhibiteur hépatique/ intestinale/ Ø rénale\r\n1 étude clinique démontre l\'inactivité\r\n',
            'user_id'=>2,
            'validated'=>1
            ] );
            ...
            'target_id'=>5,
            'force_id'=>4,
            'notes'=>'16 sujets sains métaboliseurs rapides du CYP2D6. (Enzymatic Therapy, Inc., Green\r\nBay, WI, lot #41924, standardisé à 2.5% de triterpene glycosides par comprimé) 40 mg X2/J pendant 14J. Débrisoquine dose unique par voie orale de 5mg. Pas de modification de l\'activité du CYP2D6\r\n',
            'user_id'=>2,
            'validated'=>1
            ] );
...
Hinteraction::create( [
    ...
    Hinteraction::create( [
        ...
        'target_id'=>36,
        'force_id'=>4,
        'notes'=>'Démontré sur modèles animaux.\r\nIl y a surtout un risque en cas de surdosage.\r\nL\'hépatotoxicité serait liée à des sennosides, alcaloïdes laxatifs.',
        'user_id'=>2,
        'validated'=>1
        ] );
    ...
    Hinteraction::create( [
        ...
        'target_id'=>41,
        'force_id'=>2,
        'notes'=>'Dans un cas clinique une augmentation AUC du 5-FU a été décrite\r\nDes études cliniques suggèrent que des extraits de  ginkgo i.v. (EGb 761, Tanakan, Ipsen) co-administrés avec 5-FU pourraient être bénéfiques dans le cas d\'un cancer du colon métastatique. Si tel était le cas on entrevoit aussi la possibilté d\'une augmentation de la toxicité du 5-FU.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>36,
        'force_id'=>1,
        'notes'=>'Les études pharmacocinétiques cliniques et les études toxicologiques sur animal ne montrent pas d\'hépatoxicité d’après un comité d\'étude de la pharmacopée européenne.\r\n2 cas rapportés :\r\n- Levitsky décrit le cas d\'une patiente de 50ans, admise pour ictère, urines foncées, jaunisse.\r\nLes paramètres hépatiques étaient élevés (ASAT, ALAT, PAL)\r\nLa patiente consommait de l\'actée à grappe (500mg/j) depuis 5 mois pour lutter contre les troubles de la ménopause. \r\nUne transplantation hépatique a été nécessaire.\r\n- Lynch décrit le cas d\'une patiente de 54 ans, admise pour fatigue, perte de mémoire et perte de poids. Elle prenait de l\'actée à grappe depuis 8 mois (1g/j).\r\nLes paramètres hépatiques étaient élevés et une biopsie hépatique a révélée une inflammation et une nécrose à certains endroits. La patiente a développé ensuite une encéphalopathie et une transplantation hépatique a été nécessaire.\r\nDe plus, la rédaction Prescrire, dans son N°351, fait référence aux mises en garde de l\'Agence britannique du médicament. La dernière, datée d\'octobre 2012, intervient après un cas d\'atteinte hépatique grave qui a nécessité une transplantation.\r\nCe sont au total 53 observations d\'effets indésirables imputés à l\'Actée à grappes qui ont été notifiées à l\'Agence britannique (dont 36 atteintes hépatiques).\r\nDans le N° 275 de Prescrire, il est mentionné qu\'en Juillet 2006 l\'agence française des produits de santé a fait état de 42 cas d\'atteintes hépatiques collectés par l\'Agence européenne ou publiés liées à l\'actée à grappe.',
        'user_id'=>2,
        'validated'=>1
        ] );  
...
Hinteraction::create( [
    ...
    Hinteraction::create( [
        ...
        'target_id'=>2,
        'force_id'=>4,
        'notes'=>'Pas d\'interaction aux concentrations thérapeutiques.\r\nInhibition possible du CYP3A4.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>2,
        'force_id'=>3,
        'notes'=>'Le jus de citron est inhibiteur faible au niveau clinique. Pour l\'inhibition irréversible, les courbes pour les jus de pamplemousse/pomelo et de citron vert sont modifiées de 4 et 1,4 fois respectivement.\r\n250 ml de jus de citron vert n\'influence pas l\'aire sous la courbe de la felodipine ',
        'user_id'=>2,
        'validated'=>1
        ] );
...
Hinteraction::create( [
    ...
    Hinteraction::create( [
        ...
        Hinteraction::create( [
            ...
            'target_id'=>49,
            'force_id'=>5,
            'notes'=>'Une étude sur volontaires sains ne montre pas d\'activité.\r\nD\'autres articles mettent en évidence une interaction entre l\'ail et la warfarine avec un risque d\'augmentation de l\'INR.\r\nDe Lima Toccafondo (2012) évoque 2 case report de patients stabilisés sous warfarine qui ont vu doublé leur INR suite à la prise d\'ail (quantité non précisée).',
            'user_id'=>2,
            'validated'=>1
            ] );
            ...
            Hinteraction::create( [
                ...
                'target_id'=>49,
                'force_id'=>3,
                'notes'=>'En théorie, des quantités excessives de gingembre pourrait augmenter le risque de saignement. Le gingembre est censé inhiber la thromboxane synthétase et diminuer de l\'agrégation plaquettaire.\r\nChavez (2006) rapporte le cas d\'une patiente de 76 ans traitée par \"phenprocoumon\", cholécalciférol, captopril, pirétanide et digoxine. Cette patiente a présenté un epistaxis avec élévation de l\'INR.',
                'user_id'=>2,
                'validated'=>1
                ] );
...
Hinteraction::create( [
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Un cas d\'hépatite fulminante lors de l\'auto-médication avec Exolise® a nécessité une transplantation hépatique.\r\nVerhelst décrit le cas d\'une patiente qui a présente une hépatite aiguë après la prise de thé vert. A l\'arrêt, l\'amélioration a été rapide.\r\nEntre 1999 et 2003, 13 cas d\'atteinte hépatique ont été collectés par la pharmacovigilance dont 9 cas en France et 4 en Espagne, en lien avec l\'utilisation de l\'Exolise®, extrait hydro-alcoolique de thé vert.\r\nLe composé responsable de cette hépatotoxicité est le gallate d\'épigallocatécol (GEPC).',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>13,
    'force_id'=>3,
    'notes'=>'Glabridine, isoflavane majoritaire de la racine de réglisse, se lie de manière compétitive aux récepteurs oestrogéniques in vitro de manière concentration-dépendant.\r\nThéoriquement, le réglisse pourrait interférer avec un traitement hormonal en raison des effets oestrogéniques et anti-oestrogéniques',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Hinteraction::create( [
        ...
        'target_id'=>1,
        'force_id'=>5,
        'notes'=>'Induit ou pas le cytochrome P450 1A2, mais de manière moins importante que pour le CYP3A4.\r\nL\'effet a été observé que chez les femmes',
        'user_id'=>2,
        'validated'=>1
        ] );       
        ...
        Hinteraction::create( [
            ...
            Hinteraction::create( [
                ...
                Hinteraction::create( [
                    ...
                    'target_id'=>2,
                    'force_id'=>3,
                    'notes'=>'L’étude in vitro montre que l’acide maslinique (MA) du fruit d’Olea europea n’a inhibé que faiblement l’activité du CYP3A4 dans les microsomes de foie humain avec une valeur IC50 égale à 46.1 µM. Une autre  étude portant sur la cinétique des enzymes (enzyme kinetic) a montré que  MA était un faible inhibiteur compétitif du CYP3A4 humain (Ki = 18.4µM) comparé au kétoconazole, un inhibiteur spécifique du CYP3A4 humain (Ki = 0.02µM) \r\nL’acide oleanolique est un inhibiteur compétitif encore plus faible du CYP3A4 (IC50 >100µM ; Ki =13.3µM)\r\n',
                    'user_id'=>2,
                    'validated'=>1
                ] );
...
Hinteraction::create( [
    ...
    Hinteraction::create( [
        ...
        'target_id'=>49,
        'force_id'=>4,
        'notes'=>'Des recherches cliniques montrent qu\'en buvant du jus de canneberge 250 ml par jour pendant 7 jours ou cocktail à base de jus de canneberge (Ocean Spray, le jus de canneberge 27%) 240 ml par jour pendant 14 jours, chez les patients stabilisés sous warfarine, n\'augmente pas sensiblement l\'activité anticoagulante de la warfarine et sa pharmacocinétique. Une autre étude sur volontaires sains montre une aire sous la courbe de la warfarine diminuée de 30%.\r\n\r\nUn certain nombre de case reports suggèrent que le jus de canneberge peut augmenter l\'INR des patients prenant de la warfarine, et un cas de patient décédé à la suite de cette interaction a aussi été décrit. Pour les autres patients des INR instables ont été décrits dans la majorité des cas. ',
        'user_id'=>2,
        'validated'=>1
        ] );
...
Hinteraction::create( [
    ...
    'target_id'=>72,
    'force_id'=>2,
    'notes'=>'Une utilisation excessive donne un hyperaldosteronisme d\'où une HTA.\r\n3 cas reportés avec une hypertension modérée (et hypokaliémie) à la suite de la consommation de réglisse. (Elinav, 2003 ; Lin, 2003 ; Murphy, 2009)',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>61,
    'force_id'=>2,
    'notes'=>'En moyenne, sur une période de 12 jours, l\'ail diminue la clairance du docétaxel chez uniquement chez les patients porteurs d\'un allèle CYP3A5 * 1A.\r\nMais pas d\'IM si pas de modification de l\'activité du CYP 3A5.   ',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>38,
    'force_id'=>1,
    'notes'=>'Case report d\'allongement du QT suite à la consommation de ginseng asiatique.\r\nTorbey (2011) décrit le cas d\'une patiente de 43 ans, amenée aux urgences pour malaise et légères crises tonico-cloniques. A l\'ECG, QT long.\r\nLa patiente consommait depuis 6 mois du café et 4L de Ginseng.\r\nA l\'arrêt de cette consommation, pas de nouvel épisode.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>37,
    'force_id'=>2,
    'notes'=>'L\'abus ou une mauvaise utilisation excessive donne un hyperaldosteronisme d\'où une hypokaliémie.\r\n6 cas rapportés d\'hypokaliémie sévère à la suite de la consommation de réglisse en plus ou moins grande quantité. (Elinav, 2003 ; Francini-Pesenti, 2008 ; Lin, 2003 ; Mumoli, 2008 ; Murphy, 2009 ; Yorgun, 2010)\r\nRetour à la normale après arrêt de la consommation de réglisse.\r\n\r\n',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>40,
    'force_id'=>1,
    'notes'=>'\r\n    Case report avec addition de la toxicité hépatique   ',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Hinteraction::create( [
        ...
        'target_id'=>36,
        'force_id'=>3,
        'notes'=>'Le mécanisme n\'est pas connu mais démontré cliniquement.\r\nSkoulidis décrit le cas d\'une patiente de 57 ans, admise pour nausées, anorexie, douleurs abdominales et jaunisse.\r\nCela est apparu 2 semaines après la consommation de 2 produits à base de plantes chinoises.\r\nL\'état de la patiente a nécessité une transplantation hépatique.\r\nLes dosages ont révélé la présence d\'éphédrine ; l\'hépatotoxicité a été imputé à l\'Ephédra.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>58,
        'force_id'=>1,
        'notes'=>'Un cas d\'une femme de 35 ans a été rapporté avec la déclaration d\'une neuropathie subaiguë après co-ingestion de millepertuis (500 mg/ pendant 4 semaines). Lors de la complète élimination du millepertuis les symptômes ont disparus.\r\nDe plus, le fabricant rapporte des effets indésirables comme agitation, étourdissements, insomnie, nervosité, somnolence, tremblements et vertiges dans des essais cliniques ',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>71,
        'force_id'=>1,
        'notes'=>'Gabardi évoque le cas d\'une personne de 56 ans qui a été admise avec une créatinine élevée. Cette personne a développé une maladie kystique rénale bilatérale à la suite de la consommation de créosotier.\r\nLe composé responsable est l\'acide nordihydroguaiarétique.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            Hinteraction::create( [
                ...
                'target_id'=>73,
                'force_id'=>5,
                'notes'=>'En théorie, des quantités excessives de gingembre pourraient augmenter le risque de saignement. Le gingembre est censé inhiber la thromboxane synthétase et diminuer de l\'agrégation plaquettaire.\r\nMais les résultats d\'études pharmacologiques suggèrent que le gingembre n\'augmente pas l\'effet anticoagulant de la warfarine, ni ne modifie la coagulation ou l\'agrégation des plaquettaire. Cependant, deux case report décrivent INR augmentés lors d’association avec du gingembre séché ou des thés au gingembre. Une étude prospective, longitudinale signale également une augmentation du risque de saignement auto-déclaré.',
                'user_id'=>2,
                'validated'=>1
                ] ); 
...
Hinteraction::create( [
    ...
    Hinteraction::create( [
        ...
        'target_id'=>71,
        'force_id'=>2,
        'notes'=>'La consommation de Yohimbe peut entraîner le développement d\'une insuffisance rénale progressive et d\'une protéinurie ; cela est réversible à l\'arrêt.\r\nLe composé responsable est la yohimbine',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>73,
        'force_id'=>4,
        'notes'=>'Les recherches cliniques chez l\'homme suggèrent que le ginseng ne modifie pas l\'agrégation plaquettaire.\r\nLes données diffèrent quant à l\'action du ginseng asiatique sur l\'agrégation plaquettaire et sur la coagulation.\r\nChavez (2006) évoque le cas d\'un patient de 47 ans avec pour antécédent un remplacement de valve mitrale. Il était traité par Warfarine et Diltiazem notamment.\r\nL\'INR avait baissé avec la prise concomitante de Ginseng asiatique.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>21,
        'force_id'=>3,
        'notes'=>'La luzerne semble modifier la réponse immunitaire. Elle serait immunostimulante.\r\nLight (2003) :\r\nCas rapporté d\'une patiente de 59 ans, greffée rénale.\r\nL\'incident s\'est passé 16 ans après la greffe ; la patiente était toujours sous ciclosporine et azathioprine.\r\nElle a consommé de la luzerne et de l\'actée à grappe sur avis gynécologique.\r\n4 semaines plus tard, des analyses ont montré une élévation de la créatinine sans modification du taux de ciclosporine. Une biopsie rénale a été réalisée et a montré des signes de rejet aigu.\r\nL\'actée à grappe n\'étant pas connu pour ses propriétés immunostimulantes, cet incident a été imputé à la luzerne.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            'target_id'=>9,
            'force_id'=>1,
            'notes'=>'Le jus de pomme est inhibiteur de OATP 1 et 3.\r\nLa recherche clinique montre que l\'administration concomitante de jus de pomme diminue la biodisponibilité de la fexofénadine d\'environ 78%\r\nPar contre le jus de pomme pourrait inhiber l\'OATP sur seulement une courte période. Par conséquent, 4 heures entre les 2 prises pourrait éviter cette interaction',
            'user_id'=>2,
            'validated'=>1
            ] );
        ...
        Hinteraction::create( [
            ...
            Hinteraction::create( [
                ...
                Hinteraction::create( [
                    ...
                    'target_id'=>21,
                    'force_id'=>3,
                    'notes'=>'Stimulation des glandes du système immunitaire.\r\nActivation potentielle de la production d\'INF.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>21,
                    'force_id'=>5,
                    'notes'=>'Selon une étude in vitro réalisée sur des lymphocytes murins, le chardon-marie est immunostimulant. Les résultats ont montré un augmentation de la prolifération lymphocytaire en présence de chardon-marie.\r\nIl y aurait élévation de la production d\'INF-gamma et d\'IL10.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>21,
                    'force_id'=>3,
                    'notes'=>'Activité immuno-modulatoire mise en évidence in vitro.\r\nInhibition de la production d\'IL12, d\'INF-gamma.\r\nLes composés en cause sont les tanshinones.\r\n',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>38,
                    'force_id'=>2,
                    'notes'=>'Risque de majoration de troubles cardiaques en cas d\'association entre la passiflore et des médicaments induisant un allongement du QT.\r\nFisher décrit le cas d\'une patiente de 34 ans qui a développé de sévères nausées, diarrhées, une somnolence, un allongement du QT et des épisodes de tachycardie ventriculaire après la prise de passiflore à des doses thérapeutiques.\r\nLe mécanisme semble lié aux flavonoïdes et aux alcaloïdes indoliques.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>71,
                    'force_id'=>2,
                    'notes'=>'Gabardi évoque le cas d\'un patient chez qui la fonction rénale s\'est aggravé suite à la consommation de la Griffe de chat.\r\nSa fonction rénale s\'est amélioré à l\'arrêt de cette prise de Griffe de chat.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>71,
                    'force_id'=>2,
                    'notes'=>'Selon Gabardi, depuis 1994, la FDA a reçu 1000 notifications d\'effets indésirables liés à la consommation d\'éphédra.\r\nIl y a eu 2 cas rapportés de lithiase rénale.\r\nLe composé en cause est l\'éphédrine.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>71,
                    'force_id'=>3,
                    'notes'=>'Gabardi évoque le cas d\'une patiente de 47 ans qui a développé une lithiase rénale à la suite de la consommation quotidienne de Canneberge.\r\nCela serait dû à la présence d\'oxalate de calcium.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>71,
                    'force_id'=>1,
                    'notes'=>'Cas d\'un patient ayant développé un syndrome hépato-rénal.\r\nLe composé en cause serait le menthofurane.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>71,
                    'force_id'=>1,
                    'notes'=>'Gabardi évoque 4 cas de néphrotoxicité liés à la consommation de Thévétia dont 3 sont décédés de défaillances multiviscérales.\r\nLes analyses histo-pathologiques en post-mortem ont révélé une nécrose tubulaire rénale.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>71,
                    'force_id'=>3,
                    'notes'=>'2 femmes de moins de 50 ans pour lesquelles un diagnostic d\'une néphrotoxicité consécutive à un régime amaigrissant constitué de Stephania tetandra et de Magnolia officinalis.\r\nCes patientes ont dû être dialysées.\r\nLa molécule toxique est l\'acide méfénamique.',
                    'user_id'=>2,
                    'validated'=>1
                    ] );
                    ...
                    Hinteraction::create( [
                        ...
                        'target_id'=>71,
                        'force_id'=>1,
                        'notes'=>'Insuffisance hépato-rénale.\r\nToxicité fréquente chez les enfants ; en per os et même pour une application cutanée.\r\n3 Case report :\r\nBouziri décrit le cas d\'un patient de 30 mois, admis à l\'hopital dans le coma. Il présentait des brûlures du second degré. On lui avait fait un bandage occlusif avec du chardon à glu. Les paramètres hépatiques et rénaux étaient élevés et on a retrouvé de l\'atractyloside dans les urines.\r\nSkalli décrit le cas d\'un enfant de 12 ans, hospitalisé pour des vomissements, épigastralgies et diarrhées noirâtres. Il a été très rapidement dans le coma. L\'évolution a été favorable par la suite. \r\nL\'enfant a avoué avoir consommé de la racine de chardon à glu.\r\nMouaffak décrit le cas d\'un enfant de 12 ans, sans antécédents particulier, admis aux urgences pour la prise en charge d\'un coma. 3 jours avant, il avait présenté une gastro-entérite qui avait coïncidé à l\'ingestion de fruits saisonniers ou de plantes sauvages. Puis, son état de conscience s\'est aggravée.\r\nLe bilan biologique pratiqué montrait une altération de la fonction rénale, une cytolyse intense ainsi qu\'une rhabdomyolyse. L\'enfant n\'a pas survécu.\r\nAu total, entre 1981 et 2004, 240 cas d\'intoxication par le chardon à glu ont été déclarés par le centre antipoison et de pharmacovigilance du Maroc.\r\nLe composé en cause est l\'atractyloside et la gummiférine.',
                        'user_id'=>2,
                        'validated'=>1
                        ] );
                        ...
                        Hinteraction::create( [
                            ...
                            'target_id'=>71,
                            'force_id'=>1,
                            'notes'=>'Plusieurs cas de toxicité notamment d\'insuffisances rénales aiguës, de nécrose tubulaire.\r\nCette toxicité est liée à l\'atractylate de potassium présent dans la racine.',
                            'user_id'=>2,
                            'validated'=>1
                            ] );
...
Hinteraction::create( [
    ...
    'target_id'=>71,
    'force_id'=>3,
    'notes'=>'La menthe verte a entraîné des dommages au niveau rénal chez le rat. \r\nLa créatinine et l\'urée étaient augmentées.\r\nLes activités des enzymes étaient aussi modifiées.\r\nDes changements histologiques ont aussi été observés.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Kauma décrit le cas d\'une patiente de 22 ans, admise pour jaunisse.\r\nLes enzymes hépatiques étaient élevées. \r\nLe diagnostic d\'hépatite aiguë a été posé.\r\nSon état s\'est amélioré à l\'hôpital mais nouvelle aggravation à sa sortie.\r\nA l\'interrogatoire, lors de la 2ème hospitalisation, il a été mise en évidence que la patiente consommait du créosotier. Elle avait arrêté pendant la 1ère hospitalisation puis repris à sa sortie.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Des cas d\'hépatites cytolytiques décrits.\r\nGori décrit les cas de 2 patients qui ont développé une jaunisse. Les enzymes hépatiques étaient élevées.\r\nLe diagnostic de stéatose hépatique moyenne et hépatomégalie a été posé.\r\nA l\'interrogatoire, les patients ont dit consommer une plante, qui a été identifiée comme étant la germandrée.\r\nLes paramètres hépatiques se sont améliorés à l\'arrêt de la consommation de cette plante.\r\nSelon Chen (2011), plus de 30 cas d\'hépatites cytolytiques, hépatites chroniques ou cirrhoses ont été recensés après la consommation de Germandrée, et principalement en France. 1 cas mortel a été recensé également.\r\nLa toxicité de cette plante est liée à la présence de diterpénoïdes transformés par des CYP450 en métabolites réactifs qui déplètent le glutathion et altèrent le cytosquelette et la membrane cellulaire.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Des cas d\'hépatites aiguës décrits.\r\n4 Case Report (Articles : Bae, Furukawa, Mazzanti, Park)\r\n\r\nSelon l\'ANSM :\r\nEn 2006, l\'Agence britannique (MHRA) a fait état de toxicité hépatique chez plusieurs personnes et a recommandé l\'utilisation de cette plante uniquement après avis médical.\r\nEn 2007, les autorités australiennes ont indiqué 10 cas d\'hépatotoxicité.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Cas d\'hépatites aiguë, cytolytique ou mixte.\r\nConti décrit le cas d\'une patiente de 46 ans, admise pour nausées, anorexie et douleurs abdominales. Elle consommait du Jin Bu Huan pour traiter des insomnies.\r\nA l\'admission, ses enzymes hépatiques étaient élevées. \r\nAprès arrêt de la plante, le bilan est redevenu normal.\r\nLe diagnostic d\'hépatite aigue avec stéatose a été posé.\r\nLe composé responsable de la toxicité serait la tétrahydropalmitine, qui a des analogies structurales avec les alcaloïdes pyrrolizidiniques.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>3,
    'notes'=>'Une hépatotoxicité peut survenir surtout si la consommation est très importante.\r\nSelon Tovar, plusieurs cas d\'hépatites ont été décrits suite à la consommation de Gui.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Des cas de syndrome hépato-rénal entraînant une insuffisance hépatique et rénale ont été observés.\r\nLe composé en cause serait le menthofurane.',
    'user_id'=>2,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    'target_id'=>36,
    'force_id'=>2,
    'notes'=>'Chen (2007) décrit le cas d\'un patient de 42 ans, hospitalisé pour douleurs abdominales, jaunisse et inconfort.\r\nLe patient prenait du Tusanqi depuis 2 semaines.\r\nA l\'examen, le patient présentait une hépatomégalie et de l\'ascite.\r\nAprès la prise d\'un traitement adapté, l\'état de ce patient s\'est amélioré ; 1 mois après le début de ce traitement, le patient a refusé de le continuer et il est décédé 2 mois après sa sortie de l\'hôpital.\r\nLes constituants en cause sont les alcaloïdes pyrrolizidiniques.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Selon Chen (2011), depuis 1976, il y a eu environ 70 cas d\'hépatites après consommation d\'Hoffe ; 3 cas ont été mortels avec développement d\'une défaillance hépatique fulminante.\r\nLe composé responsable est la disobulbine-D.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>1,
    'notes'=>'Cas d\'insuffisance hépato-cellulaire et d\'hépatite fulminante.\r\nCette toxicité est liée à l\'atractylate de potassium présent dans la racine.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>5,
    'notes'=>'Cas chez le rat d\'hépatotoxicité.\r\nLes composés responsables de cette toxicité seraient les géniposides.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Hinteraction::create( [
        ...
        'target_id'=>36,
        'force_id'=>3,
        'notes'=>'La menthe verte a causé des dommages hépatiques chez le rat de manière dose-dépendante.\r\nLes études histopathologiques chez le rat ont montré une dégénérescence et une nécrose des hépatocytes.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>73,
        'force_id'=>2,
        'notes'=>'Les études in vitro démontrent un effet antiagrégant et anticoagulant par les composés soufrés.\r\nQuelques études in vivo le montrent également.\r\nBorrelli (2007) évoque 4 cas rapportés où les patients ont présenté des hémorragies suite à une consommation d\'ail. La plupart du temps, cette consommation était très importante.\r\nDe Lima Toccafondo (2012) évoque 2 case report de patients stabilisés sous warfarine qui ont vu doublé leur INR suite à la prise d\'ail (quantité non précisée).',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>73,
        'force_id'=>3,
        'notes'=>'Effet anti-agrégant plaquettaire démontré chez le rat. \r\nPrésence de dérivés coumariniques. \r\nChavez (2006) évoque le cas d\'une patiente de 46 ans avec des antécédents d\'AVC, douleurs rhumatismales et de FA. La patiente était traitée par Warfarine + digoxine + furosémide. On a observé un taux de prothrombine et un INR multiplié par 2. \r\nFugh-Berman (2001) présente le cas d\'une patiente avec un antécédent de remplacement de valve mitrale et traitée par Warfarine. Elle a développé des bleus et son INR était à 10.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>73,
        'force_id'=>3,
        'notes'=>'Description d\'un cas d\'après Chavez (2006):\r\nCas d\'un homme de 62 ans avec remplacement d\'une valve mitrale. Patient aussi traité par Digoxine, Furosémide, Captopril. INR augmenté. Le mécanisme probable d\'interaction est certainement dû aux coumarines présentes dans la sauge.\r\n2 autres cas décrits par Fugh-Berman (2001): un patient de 66 ans et une patiente de 48 ans ; INR augmenté dans les deux cas.\r\n',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>99,
        'force_id'=>2,
        'notes'=>'Etude chez le rat : administration de 100mg/kg de curcuma et 25mg/kg d\'acide mycophénolique.\r\nMultiplication par 6 des taux en acide mycophénolique libre et baisse de 25% des dérivés glucuronidés.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>103,
        'force_id'=>1,
        'notes'=>'3 cas rapportés dont notamment :\r\n1 patient de 37 ans ayant subi une greffe rénale, sous azathioprine et ciclosporine. Lors de consommation de camomille (de 1l à 1.5l de tisane), il a été nécessaire de diminuer les doses de ciclosporine; à l\'arrêt, nouveau réajustement des doses a été mis en place.\r\n1 patiente de 33 ans, greffée rénale, sous ciclosporine et mycophénolate. Les taux de ciclosporine se sont vus augmenté alors que la patiente consommait de la camomille, à l\'arrêt de la consommation de la camomille, baisse des taux de ciclosporine.\r\nL\'augmentation de la concentration en ciclosporine après consommation de grande quantité de tisane de camomille majore le risque d\'effets indésirables.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>115,
        'force_id'=>2,
        'notes'=>'Etude chez des rats.\r\nUtilisation de la menthe poivrée sous forme d\'huile essentielle.\r\nAugmentation significative de la biodisponibilité de la ciclosporine.\r\nL\'huile essentielle de menthe officinale est inhibitrice du CYP3A4.\r\nCela pourrait permettre de diminuer les doses de ciclosporine, dans un but économique.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>2,
        'force_id'=>3,
        'notes'=>'Induction du CYP3A4 in vitro.\r\nInteractions potentielles avec les médicaments métabolisés par CYP3A4.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            'target_id'=>105,
            'force_id'=>4,
            'notes'=>'Etude prospective longitudinale déterminant le risque de saignements et de modification de l\'INR par les MCA sur 171 adultes recevant de la warfarine. Pas d\'augmentation significative du nombre de saignements ni de l\'INR par la\r\nconsommation d\'ail',
            'user_id'=>3,
            'validated'=>1
            ] );
            ...
            'target_id'=>121,
            'force_id'=>2,
            'notes'=>'Un case report décrivant une crise convulsive chez un patient consommant du valproate + phenytoïne + ginkgo. On note un taux subthérapeutique des l\'antiépileptiques\r\nPrécaution d\'emploi des extraits de ginkgo avec les molécules à marge thérapeutique étroite',
            'user_id'=>3,
            'validated'=>1
            ] );
            ...
            Hinteraction::create( [
                ...
                Hinteraction::create( [
                    ...
                    'target_id'=>124,
                    'force_id'=>2,
                    'notes'=>'Un case report de crise épileptique chez un patient consommant du valproate de Na + ginkgo biloba. On note un taux subthérapeutique de l\'antiépileptique\r\nPrécaution d\'emploi des extraits de ginkgo avec les molécules à marge thérapeutique étroite',
                    'user_id'=>3,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>125,
                    'force_id'=>2,
                    'notes'=>'Diminution de l\'INR chez un patient préalablement stable avec pour\r\nconséquence une thrombose de prothèse de valve aortique',
                    'user_id'=>3,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>127,
                    'force_id'=>2,
                    'notes'=>'Etude sur 12 patients recevant 150mg d\'amitriptyline et 900 mg par jour de millepertuis pendant 15 jours. Diminution significative les AUC\r\nde l\'amitriptyline et de nortriptylline. Les métabolites urinaires diminuent également',
                    'user_id'=>3,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>149,
                    'force_id'=>2,
                    'notes'=>'1 case report d\'échec thérapeutique de levothyroxine aux doses usuelles chez un nouveau né souffrant d\'hypothyroïdisme\r\nprimaire et nourri au lait de soja. Réussite du traitement après remplacement par du lait de soja par du lait de vache',
                    'user_id'=>3,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>150,
                    'force_id'=>2,
                    'notes'=>'Etude contrôlée par placebo sur 20patients non fumeurs. Un pré traitement par Daidzéine augmente l\'AUC, les taux maximum et la 1/2 vie d\'élimination de la théophylline de façon significative\r\nMieux vaut ne pas associer le soja à la théophylline, médicament à marge thérapeutique étroite',
                    'user_id'=>3,
                    'validated'=>1
                    ] );
                    ...
                    'target_id'=>151,
                    'force_id'=>2,
                    'notes'=>'1 case report avec diminution d\'INR chez un patient stable sous warfarine après consommation quotidienne de lait de soja\r\npendant 4 semaines',
                    'user_id'=>3,
                    'validated'=>1
                    ] );
...
Hinteraction::create( [
    ...
    'target_id'=>2,
    'force_id'=>1,
    'notes'=>'Augmentation des AUC de médicaments métabolisés par CYP3A4 si consommation concomitante de Pomélo.\r\nIl s\'agit principalement d\'une inhibition du CYP3A4 intestinal (d\'où une augmentation de l\'absorption digestive du substrat).\r\nLa bergamottine et dihydroxybergamottine sont des inhiteurs suicide. Dose (très approximative): 200 ml de jus. \r\nInhibition réversible en 24-72h.\r\nLes médicaments concernés pour l\'instant sont essentiellement à marge thérapeutique relativement étroite : statines (atorvastatine, simvastatine), immunosuppresseurs (ciclosporine, tacrolimus, sirolimus), cisapride, amiodarone (augmentation de 50% de l\'AUC d\'amiodarone et chez le volontaire sain), dihydrodyripines, carbamazépine,  buspirone, benzodiazépines (diazépam, triazolam, midazolam)\r\nMais de nombreuses interactions potentielles sont à prévoir...',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>8,
    'force_id'=>1,
    'notes'=>'Augmentation des AUC des médicaments pris en charge par la P-gp si prise concomitante de Pomélo.\r\nLa faible activité inhibitrice a été démontrée sur la P-gp intestinale de volontaires sains exposés à la digoxine.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>1,
    'notes'=>'L\'inhibition a été démontré.\r\nPlusieurs cas d\'augmentation d\'AUC de médicaments métabolisés par CYP3A4 si prise concomitante de pamplemousse.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>170,
    'force_id'=>2,
    'notes'=>'Pomélo = inhibiteur du CYP3A4\r\nEtude randomisée en cross over sur 24 volontaires sains recevant une dose unique de sildénafil (50mg) avec du jus de pomélo ou de l\'eau.\r\nAugmentation',
    'user_id'=>3,
    'validated'=>1
    ] );
    ...
    Hinteraction::create( [
        ...
        'target_id'=>172,
        'force_id'=>4,
        'notes'=>'Etude sur 12 volontaires sains qui ont reçu une dose unique de 200mg de ciclosporine et 240mL de pamplemousse. L\'interaction a été évaluée en prélevant un échantillon de sang 36h après la prise.\r\nAucun effet de la canneberge sur les concentrations en ciclosporine.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>172,
        'force_id'=>2,
        'notes'=>'Augmentation des concentrations en ciclosporine si prise concomitante de pamplemousse.\r\nEtude sur 12 volontaires sains qui ont reçu une dose unique de 200mg de ciclosporine et 240mL de pamplemousse.\r\nL\'interaction a été repérée en prélevant un échantillon de sang 36h après la prise.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>175,
        'force_id'=>3,
        'notes'=>'Etude chez le rat. \r\nAdministration de tacrolimus à la dose de 0,6mg/kg avec soit du pamplemousse, soit du gingembre, soit du curcuma, soit tout seul. \r\nTaux de tacrolimus significativement plus élevés si administration concomitante de pamplemousse, gingembre et curcuma.\r\nLe curcuma inhibe aussi CYP3A4 et P-gp dans cette étude chez des rats.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'target_id'=>175,
        'force_id'=>3,
        'notes'=>'Etude chez le rat.\r\nAdministration de tacrolimus à la dose de 0,6mg/kg avec soit du pamplemousse, soit du gingembre, soit du curcuma, soit tout seul. \r\nTaux de tacrolimus significativement plus élevés si administration concomitante de pamplemousse, gingembre et curcuma.\r\nInhibition CYP3A4 et P-gp par gingembre mise en évidence dans cette étude sur des rats.',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            'target_id'=>177,
            'force_id'=>1,
            'notes'=>'Cas d\'un patient de 52 ans, greffé hépatique. Les taux en tacrolimus était bien stabilisés après la greffe.\r\nLors d\'un entretien pharmaceutique en post-greffe et avant la sortie, il avait été rappelé au patient d\'éviter pomélo.\r\n4 mois après la transplantation, apparition de fièvre et anxiété.\r\nRéalisation de dosage : taux de tacrolimus augmenté.\r\nLe patient a été interrogé et le seul changement était une consommation considérable de confiture d\'orange.\r\nCette confiture d\'orange était faite maison et contenait aussi du pomélo car il n\'y avait pas d\'orange amère de disponible à l\'époque.',
            'user_id'=>2,
            'validated'=>1
            ] );
...
Hinteraction::create( [
    ...
    'target_id'=>185,
    'force_id'=>1,
    'notes'=>'Etude sur 12 volontaires sains. Administration de midazolam par voie orale et voie IV avant et après 8 jours d\'échinacée (400mg 4 fois /jour), diminution de l\'aire sous la courbe du midazolam de 23%. Augmentation de la clairance systémique de 34% mais pas de modification de la clairance orale.\r\nL\'inhibition des CYP 3A4 intestinaux par l\'echinacea et l\'induction des CYP 3A4 hépatiques est le mécanisme probable\r\n',
    'user_id'=>3,
    'validated'=>1
    ] );
    ...
    'target_id'=>102,
    'force_id'=>3,
    'notes'=>'Etude chez des rats.\r\nUtilisation d\'un extrait éthanolique de Schisandra.\r\nAugmentation modérée de l\'AUC de ciclosporine si administration concomitante de Schisandra.\r\nLa schisandrine, constituant du Schisandra, pourrait inhiber les CYP3A4 et la glycoprotéine P.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>5,
    'notes'=>'La quercétine serait inhibiteur de CYP3A4.\r\nDans d\'autre articles, la quercétine a montré des propriétés inductrices du CYP3A4.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>114,
    'force_id'=>5,
    'notes'=>'La quercétine, contenue dans le Ginkgo et le Sophora du Japon, serait inhibitrice du CYP3A4 et de la P-gp.\r\nOr dans cette étude, on retrouve une diminution significative de l\'AUC de la ciclosporine A chez les rats et les cochons, ce qui va à l\'encontre de l\'effet inhibiteur évoqué de la quercétine.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>222,
    'force_id'=>1,
    'notes'=>'Etude randomisée, croisée en double aveugle contre placebo sur 16 volontaires sains (8 jours pour chaque statine). Dose unique de 10mg de sanvastatine et de 20mg de pravastatine puis 900mg de millepertuis pendant 14 jours.\r\nDiminution des concentrations de simvastatine sans diminution de celles de la pravastatine.\r\nInduction de CYP 3A4 (paroi intestinale et foie).',
    'user_id'=>3,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    'target_id'=>49,
    'force_id'=>3,
    'notes'=>'Effet anti-agrégant plaquettaire démontré chez le rat. Présence de dérivés coumariniques. \r\nChavez (2006) évoque le cas d\'une patiente de 46 ans avec des antécédents d\'AVC, douleurs rhumatismales et de FA. La patiente était traitée par Warfarine + digoxine + furosémide. On a observé un taux de prothrombine et un INR multiplié par 2.\r\nFugh-Berman (2001) présente le cas d\'une patiente avec un antécédent de remplacement de valve mitrale et traitée par Warfarine. Elle a développé des bleus et son INR était à 10.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>49,
    'force_id'=>1,
    'notes'=>'Plusieurs études pharmacodynamiques suggèrent que le ginkgo inhibe l\'agrégation plaquettaire. On pense que le constituant ginkgo biloba, le ginkgolide B, déplace le facteur d\'activation plaquettaire (PAF) de ses sites de liaison, ce qui diminue la coagulation du sang. Plusieurs rapports de cas ont également documenté des événements hémorragiques graves chez les patients prenant du ginkgo. Certaines données suggèrent que l\'utilisation à court terme de la feuille de ginkgo pourrait ne pas réduire de manière significative l\'agrégation des plaquettes et la coagulation sanguine. Une étude sur hommes sains montre qu\'un extrait de ginkgo (EGb 761) 160 mg deux fois par jour pendant 7 jours n\'a pas réduit le temps de prothrombine. Il a été suggéré que le ginkgo doit être pris pendant au moins 2-3 semaines pour avoir un effet significatif sur l\'agrégation plaquettaire. Mais une méta-analyse de 18 études (1985 patients) utilisant des extraits de ginkgo standardisés (EGb 761), 80-480 mg par jour dans les études de durée allant jusqu\'à 32 semaines, n\'a pas trouvé d\'effet significatif sur l\'agrégation plaquettaire, concentration de fibrinogène, ou TP / TCA. De plus, une dose unique de ginkgo, plus du clopidogrel ne semble pas augmenter de façon significative le temps de saignement.\r\nChavez (2006) décrit le cas d\'une patiente avec comme antécédents de l\'hypertension, FA, bypass coronaire. Elle était traitée par Warfarine et a présenté une hémorragie.\r\nMais les données différent ; certains articles dont Izzo (2012) décrivent que le Gingko n\'entraîne pas une élévation de l\'INR en association avec la Warfarine.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>49,
    'force_id'=>5,
    'notes'=>'Les données diffèrent quant à l\'action du ginseng asiatique sur l\'agrégation plaquettaire et sur la coagulation.\r\nChavez (2006) évoque le cas d\'un patient de 47 ans avec pour antécédent un remplacement de valve mitrale. Il était traité par Warfarine et Diltiazem notamment.\r\nL\'INR avait baissé avec la prise concomitante de Ginseng asiatique, passant de 3,1 à 1,5 en l\'espace de 2 semaines. Quand le patient a arrêté de prendre du Ginseng, l\'INR est remonté à 3,3 en 2 semaines.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>326,
    'force_id'=>5,
    'notes'=>'Une synergie d\'action a été décrite entre plusieurs plantes et l\'amphotéricine B.\r\nLes plantes en question sont le thym (sous forme d\'huile essentielle) et le curcuma, qui posséderaient des propriétés anti-fongiques.\r\nCette synergie a été mise en évidence in vitro sur du Candida albicans.\r\nCela permettrait peut-être de diminuer les doses d\'amphotéricine B en associant ces plantes et diminuer ainsi les EI.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>95,
    'force_id'=>1,
    'notes'=>'2 cas décrits de diarrhées après ingestion de Chardon à glu.\r\nSkalli décrit le cas d\'un enfant ayant eu des diarrhées noirâtres.\r\nMouaffak décrit le cas d\'un enfant dont les premiers symptômes étaient une gastro-entérite aigue.\r\n',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>45,
    'force_id'=>1,
    'notes'=>'La consommation de chardon à glu peut entraîner une hépatite fulminante.\r\nUne des conséquences est la survenue d\'une hypoglycémie profonde.\r\nMouaffak décrit le cas d\'un enfant décédé à la suite de consommation du chardon à glu. Dans ses analyses, la glycémie était à 0,3g/L.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>74,
    'force_id'=>1,
    'notes'=>'La consommation de chardon à glu entraîne une toxicité digestive.\r\nLa forme digestive bénigne se manifeste par des diarrhées, des vomissements, des douleurs et un ballonnement abdominal.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>76,
    'force_id'=>1,
    'notes'=>'La consommation de Thévétia du Pérou entraîne des troubles cardiaques tels que des troubles du rythme.\r\nCe sont les graines qui sont responsables de ces troubles de par la présence de glycosides fortement cardiotoxiques (thévétines A et B, nériifoline).\r\nCette toxicité ressemble à celle de la digoxine avec quelques différences néanmoins.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>74,
    'force_id'=>1,
    'notes'=>'L\'ingestion de Thévétia entraîne des nausées, vomissements, douleurs abdominales, diarrhées...\r\nCe sont les graines qui sont responsables de ces troubles.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>2,
    'notes'=>'La consommation de racine de Pelargonium exposent à des atteintes hépatiques graves.\r\nCertains extraits sont commercialisés pour certaines affections respiratoires ou ORL malgré l\'absence d\'efficacité démontrée.\r\nDans son numéro 344, Prescrire évoque que fin 2011 le centre de pharmacovigilance allemand indépendant Arznei-Telegramm a fait état d\'une notification d\'atteinte hépatique imputée à une plante du genre Pelargonium. Il s\'agissait d\'une femme de 30ans, qui avait pris des extraits de racine de Pelargonium pendant 4 jours et un jour après la fin du traitement, elle présentait une atteinte hépatique, avec ictère, urines sombres, hyperbilirubinémie et augmentation des transaminases à plus de 35 fois la valeur normale haute.\r\nEn mars 2012, l\'agence allemande du médicament a publié un bilan des notifications d\'atteintes hépatiques imputées au Pelargonium soit une trentaine d\'observations (11 hépatites et 8 ictères). D\'autres médicaments hépatotoxiques étaient parfois présents (paracétamol, ibuprofène, aspirine).',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>5,
    'notes'=>'Le desmodium est utilisé comme adjuvant dans des protocoles de chimiothérapie ayant des effets hépatotoxiques. Il est même utilisé en cas d\'hépatites virales, toxiques, médicamenteuses, auto-immune.\r\nLes principes actifs seraient les alcaloïdes indoliques et les flavonoïdes (vitexine et isovitexine) présents dans les feuilles et la tige.\r\nLe desmodium a montré des propriétés hépatoprotectrices sur des rats et quelques études ont été réalisé chez l\'homme où on a observé une baisse des transaminases.\r\nLe desmodium semble donc régénérer et protéger la cellule hépatique.\r\n\r\nL\'étude sur modèle murin (Magielse, 2013) évalue l\'effet du desmodium contre les dommages du foie induit par la d-galactosamine et l\'éthanol chez des rats en suivant les taux des différents marqueurs hépatiques (transaminases, phosphatase alcaline).\r\nLes résultats ont montré une baisse de ces marqueurs, en faveur d\'un effet protecteur du desmodium. Le composé actif mis en évidence serait le d-pinitol.\r\nPar contre, le desmodium n\'a pas d\'effet curatif.',
    'user_id'=>2,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    Hinteraction::create( [
        ...
        'target_id'=>392,
        'force_id'=>4,
        'notes'=>'Etude clinique sur 28 sujets recevant 240mg 2fois/jour durant 10 jours de millepertuis à faible taux d\'hyperforin (capsules contenant 60mg d\'extrait, à 0,25mg hypericines total et 0,88mg d\'hyperforine). Aucun effet sur la pharmacocinétique de l\' alprazolam. Aucun effet sur CYP3A4.\r\nDeuxième étude sur 7 sujets recevant 300mg 3 fois/jour durant 4 jours de millepertuis (capsule dosé à 0.3% d\'hypericine). Aucun effet sur la pharmacocinétique de l\' alprazolam. Aucun effet sur CYP3A4',
        'user_id'=>3,
        'validated'=>1
        ] );
        ...
        Hinteraction::create( [
            ...
            Hinteraction::create( [
                ...
                Hinteraction::create( [
                    ...
                    'target_id'=>491,
                    'force_id'=>3,
                    'notes'=>'La souris reçoit de l\'extrait aqueux de persil (mélange persil/eau/huile d\'olive d\'un rapport de 4:3:3, la température du mélange n\'est pas précisée) 2 heures avant une dose unique de paracétamol 80 mg/kg.\r\nLe jus de persil, contenant du méthoxsalène, augmente et prolonge l\'action analgésique du paracétamol. Les auteurs suggèrent qu\'il est possible que l\'extrait de persil réduise le métabolisme du paracétamol par une diminution significative du cytochrome P450 hépatique.\r\n\r\n',
                    'user_id'=>44,
                    'validated'=>1
                    ] );
                    ...
                    Hinteraction::create( [
                        ...
                        Hinteraction::create( [
                            ...
                            'target_id'=>496,
                            'force_id'=>4,
                            'notes'=>'Essai clinique randomisé chez 8 volontaires sains. Ils ont reçu l\'extrait standardisé ou le placebo avant l\'administration orale du midazolam (substrat sonde de CYP 3A4), flurbiprofène (substrat sonde de CYP 2C9) ou du paracétamol (substrat sonde de UDP-glucuronosyltransférase (UGT)).\r\nLes résultats indiquent que l\'utilisation à court terme de cette préparation curcuminoïde + pipérine est peu probable d\'aboutir à une interaction cliniquement significative impliquant CYP3A4, CYP2C9.\r\nAucune différence significative n\'a été observée dans le profil pharmacocinétique du flurbiprofène.',
                            'user_id'=>44,
                            'validated'=>1
                            ] );
...
Hinteraction::create( [
    ...
    'target_id'=>72,
    'force_id'=>3,
    'notes'=>'Le ginseng sibérien a provoqué de l\'hypertension chez un animal qui prenait du ginseng sibérien pendant 15 ans. \r\nLa réexposition au même produit, a effectivement provoqué l\'augmentation de la pression sanguine.',
    'user_id'=>44,
    'validated'=>1
    ] );
    ...
    'target_id'=>512,
    'force_id'=>3,
    'notes'=>'Les rats ont reçu 2 ml/kg d\'infusions de fleurs et de baies de sureau par voie orale 2 heures avant et en même temps que la morphine (5 mg/ml).\r\nLes décoctions de sureau ont diminué de manière significative l\'action analgésique de la morphine.\r\n\r\n\r\n\r\n',
    'user_id'=>44,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    'target_id'=>485,
    'force_id'=>1,
    'notes'=>'Étude randomisée en double aveugle chez 24 sujets. Avec administration par voie orale de 1000 mg de paracétamol, 130 mg de caféine, et une combinaison des deux, étude contrôlée contre placebo. Etude effectuée pour déterminer l\'effet analgésique du paracétamol par rapport à une combinaison de la caféine et du paracétamol ou de la caféine seule.\r\nLa caféine a légèrement augmenté le taux d\'absorption d\'une dose de 1 g de paracétamol (sans modification de la biodisponibilité). Ils ont également noté des effets analgésiques accrus et prolongés.',
    'user_id'=>44,
    'validated'=>1
    ] );
    ...
    'target_id'=>497,
    'force_id'=>2,
    'notes'=>'Dans une étude réalisée chez 12 volontaires masculins sains,  le citrate de caféine (120 mg) a été administré de manière concomitante avec une dose de 650 mg d\'aspirine. Il a été observé une augmentation des concentrations plasmatiques maximales des salicylates.\r\nL\'étude suggère que la caféine peut augmenter la biodisponibilité de l\'aspirine chez l\'homme.\r\n\r\n',
    'user_id'=>44,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    'target_id'=>3,
    'force_id'=>3,
    'notes'=>'L\'étude in vitro montre que l\'acide maslinique (MA) du fruit d\'Olea europea est un faible inhibiteur du CYP2C9 humain (IC50> 100µM).\r\nL\'acide oleanolique est un inhibiteur encore plus faible du CYP2C9 (IC50> 100µM)\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>3,
    'notes'=>'Une étude in vitro montre que le potentiel inhibiteur d\'extraits éthanoliques bruts, obtenus à partir de deux de jus d\'Aloe vera commerciaux différents sur l\'activité du CYP3A4, est faible (IC50 égales à 8.35 +/-0.72 mg/mL pour le jus A et 22.4 +/-5.4 mg/mL pour le jus B)\r\nJus : obtenu à partir du gel interne de la feuille\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>5,
    'force_id'=>3,
    'notes'=>'Une étude in vitro montre que le potentiel inhibiteur d\'extraits éthanoliques bruts, obtenus à partir de deux de jus d\'Aloe vera commerciaux différents  sur l\'activité du CYP2D6 est faible (IC50 égales à 2.5 +/ 2.1mg/mL pour le jus A et  43.0 +/- 2.0mg/mL pour le jus B)\r\nJus : obtenu à partir du gel interne de la feuille\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>4,
    'notes'=>'Une étude sur animaux montre que l\'administration orale d\'un extrait aqueux obtenu à partir de la poudre du fruit entier, frais, non mûr de Momordica charantia, deux fois par jour pendant 4 semaines au dosage de 20 mg/kg de poids corporel, est sans signe d\'hépatotoxicité. Il réduit les niveaux élevés de SGOT ( serum glutamic oxaloacetic transaminase, SGPT ( serum glutamic pyruvic transaminase) chez les rats diabétiques non traités.\r\nL\'administration orale chronique du jus du fruit de Momordica charantia chez l\'animal  à des doses de l\'ordre de 6ml/kg de poids corporel entraine une hépatotoxicité qui n\'a  pas été rapportée chez l\'homme malgré la large utilisation du jus du fruit en tant que plantes médicinales ou légumes.\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>3,
    'force_id'=>3,
    'notes'=>'Une étude in vitro montre que l\'extrait aqueux obtenu à partir des feuilles de M. Charantia inhibe le CYP2C9 humain avec une valeur d\'\r\nIC50 de 425,9 +/- 2.33 µg/mL\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>547,
    'force_id'=>4,
    'notes'=>'Étude clinique sur 16 volontaires sains recevant un extrait d\'Actée à grappes noires (extrait standardisé à 2,5 % de glycosides triterpéniques), 20 mg 2 fois/j pendant 14 jours avec une dose orale unique de 400 mg de Digoxine (médicament substrat de la P-gp).\r\nAucun changement significatif de la pharmacocinétique de la Digoxine et aucun effet indésirable grave signalé.\r\nActée à grappes noires ne semble pas être un puissant modulateur de la P-gp in vivo.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>560,
    'force_id'=>1,
    'notes'=>'Femme de 53 ans, sous traitement chronique avec de l\'Atorvastatine, l\'Aspirine, de  la Glucosamine/Chrondoïtine et de l\'Œstradiol (par voie vaginale), a commencé un traitement par Actée à grappes noires (type d\'extrait, quantité et durée non précisés).\r\nIl a été détecté une élévation aiguë de ses enzymes hépatiques sans aucune cause étiologique expliquée. Après l\'arrêt de l\'Actée à grappes noires, au bout d\'une semaine, les taux d\'enzymes hépatiques mesurés étaient réduits et au bout d\'un mois ils étaient retournés à la normale.\r\nMécanisme suspecté : inhibition du CYP3A4 entrainant une élévation de la concentration d\'Atorvastatine (substrat du CYP3A4) et donc une augmentation de ces effets indésirables (élévation des enzymes hépatiques).\r\nLa prise concomitante de l\'Actée à grappes noires et d\'Atorvastatine semble  augmenter le risque d\'hépatotoxicité.\r\n\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>559,
    'force_id'=>3,
    'notes'=>'Étude in vitro (2011) suggère que la co-administration de l\'Actée à grappes noires (extrait éthanolique à 75 %, standardisé à 5,6 % de glycosides triterpéniques) avec Tamoxifène pourrait interférer avec le métabolisme de ce dernier. En effet, l\'étude montre une inhibition de la formation des métabolites du Tamoxifène.\r\nMécanisme suspecté : inhibition du CYP2D6 et CYP3A4.\r\nPossible diminution de l\'efficacité clinique du Tamoxifène. \r\nCependant des études cliniques supplémentaires sont nécessaires pour déterminer la signification clinique de ces résultats in vitro.\r\n\r\nToutefois, une autre étude in vitro (2007) sur des cellules cancéreuses du sein  révèle un effet cytotoxique de l\'Actée à grappes noires ainsi qu\'une synergie d\'action avec le Tamoxifène pour l\'inhibition de la croissance des cellules cancéreuses.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>575,
    'force_id'=>4,
    'notes'=>'L\'Actée à grappes noires contient des constituants à activité œstrogénique (phyto-œstrogènes).\r\n\r\nThéoriquement, les phyto-oestrogènes peuvent changer les niveaux d\'hormones dans l\'organisme et modifier l\'efficacité des traitements hormonaux (œstrogènes ou  anti-œstrogènes). \r\n\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>578,
    'force_id'=>3,
    'notes'=>'Diminution théorique de l\'absorption du fer due à la présence importante de tanins pouvant former un complexe avec le fer.\r\n\r\nIl est conseillé de prendre l\'Actée à grappes noires à 2 heures d\'intervalle du Fer.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>104,
    'force_id'=>3,
    'notes'=>'Des études in vitro et sur modèle animal ont montré que l\'Actée à grappes noires (extrait de racines) agissait comme un agoniste partiel des récepteurs sérotoninergiques 5-HT1A et 5-HT7 ce qui suggère un blocage de la recapture de la sérotonine et donc un effet sérotoninergique potentiel.\r\n\r\nThéoriquement, la prise d\'Actée à grappes noires et de médicaments pro-sérotoninergiques peut augmenter le risque de syndrome sérotoninergique.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    'target_id'=>579,
    'force_id'=>1,
    'notes'=>'Femme de 47 ans a subi en urgence une greffe de foie pour insuffisance hépatique fulminante une semaine après avoir commencé un traitement à base d\'Actée à grappes (type d\'extrait et quantité ingérée non spécifiés). Seule le remède à base d\'Actée à grappe noire a été mis en cause.\r\nLa causalité n\'a pas été établie mais il semblerait que l\'Actée à grappes noires soit incriminée.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>575,
    'force_id'=>3,
    'notes'=>'La luzerne contient des phyto-œstrogènes qui pourraient avoir des effets similaires aux œstrogènes et des effets opposés aux anti-oestrogènes.\r\n\r\nAinsi la prise concomitante de Luzerne et d\'une pilule contraceptive peut théoriquement diminuer l\'efficacité contraceptive de la pilule.\r\nPar mesure de prévention utiliser un autre moyen de contraception (préservatifs).\r\n \r\nDe même la prise concomitante de Luzerne et d\'œstrogènes peut théoriquement modifier les effets des œstrogènes et anti-oestrogènes.\r\n\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>588,
    'force_id'=>3,
    'notes'=>'Étude in vitro réalisée sur des cultures de cardiomyocytes de rat adulte isolé par mesure transitoire de calcium montre une interférence d\'Aubépine avec un dosage sérique de Digoxine et une interaction pharmacodynamique entre les deux. \r\n\r\nCes résultats suggèrent donc d\'éviter la prise concomitante d\'extraits d\'Aubépine et de Digoxine car peut théoriquement augmenter les effets de la Digoxine et augmenter le risque d\'effets secondaires (augmentation de la toxicité).',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>72,
    'force_id'=>3,
    'notes'=>'L\'Aubépine peut diminuer la pression artérielle. \r\nRisque majoré d\'hypotension avec médicaments diminuant la pression artérielle.\r\nÉtude randomisée (2002) sur 80 patients atteints de diabète de type 2 dont 71 % prenaient des antihypertenseurs (y compris des IEC, des Inhibiteurs calciques,  des Bêta-bloquants et/ou des Diurétiques), ont pris un extrait d\'Aubépine  (LI 132, contenant des sommités fleuries séchées standardisées à 2,2 % de Flavonoïdes), 600 mg 2fois/jour ou un placebo pendant 16 semaines. \r\nDans le groupe ayant pris l\'extrait d\'Aubépine, une petite réduction de 2,6 mmHg supplémentaire de la PAD a été observé par rapport au groupe placebo.\r\nLa preuve est limitée à cette seule étude clinique. Bien que la prise d\'extrait d\'Aubépine ait provoqué une réduction de la PAD chez des patients recevant des antihypertenseurs, l\'effet clinique reste très faible. \r\nEn tant que tel, il est peu probable qu\'une hypotension cliniquement significative se produirait si l\'Aubépine est ajoutée à un traitement antihypertenseur conventionnel.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>158,
    'force_id'=>3,
    'notes'=>'Étude in vitro montre que la Ballotte noire contient des substances chimiques (hétérosides phénylpropaniques) ayant une affinité pour les récepteurs dopaminergiques.\r\nCes substances chimiques peuvent interagir avec les agonistes dopaminergiques. \r\n\r\nThéoriquement, la prise simultanée de Ballote noire et des agonistes dopaminergiques peut augmenter les effets et les effets secondaires de ces médicaments.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>45,
    'force_id'=>5,
    'notes'=>'L\'administration per os d\'un extrait brut aqueux de Ballote noire (400 mg/kg)  a considérablement réduit la glycémie chez des rats (albinos) sains et diabétiques après augmentation significative du taux sérique d\'insuline et diminution significative du taux de glycémie.\r\nCes résultats suggèrent que la Ballote noire possède un effet hypoglycémique chez le rat et, par conséquent, peut être utile pour le traitement du diabète.\r\n\r\nPotentialisation théorique de l\'effet hypoglycémiant des Antidiabétiques chez le patient diabétique.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>577,
    'force_id'=>3,
    'notes'=>'Des études in vitro et in vivo sur modèle animal ont montré le développement progressif  d\'un état d\'hypothyroïdie lors d\'une alimentation chronique avec des pousses de Bambou.\r\nThéoriquement le Bambou peut interagir avec les médicaments pour les troubles de la thyroïde du fait d\'une activité anti-thyroïdienne.\r\nIl faut éviter le bambou avec les troubles de la thyroïde tels que l\'hypothyroïdie, un goitre, ou une tumeur de la thyroïde. En effet, l\'utilisation prolongée de pousses de bambou peuvent aggraver ces troubles.',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>578,
    'force_id'=>2,
    'notes'=>'Le son de blé est riche en fibres. \r\nLa fibre peut théoriquement diminuer l\'absorption et  l\'efficacité des médicaments pris par voie orale.\r\n \r\nEn règle générale, tous les médicaments pris per os doivent être pris une heure avant ou quatre heures après le son de blé pour prévenir cette interaction.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>591,
    'force_id'=>1,
    'notes'=>'Etude clinique en simple aveugle, contrôlée par placebo, sur 72 patients diabétiques non contrôlés sous glibenclamide. Le groupe traité reçoit une cuillère à soupe de jus d\'Aloe vera (gel de la feuille dilué à 80%) 2x/j, le matin et avant le coucher, sur 42 j en plus de leur traitement habituel (glibenclamide :2*5mg/j). \r\nDiminution significative de la glycémie et des triglycérides. Pas de modification pour le cholestérol.',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>1,
    'notes'=>'Des études in vitro réalisées sur des microsomes hépatiques humains et intestinales de rats ont montré que le jus de Canneberge entrainait une inhibition significative de l\'activité de l\'isoenzyme CYP3A4 (évalué par le métabolisme de la Nifédipine, substrat du CYP3A4).\r\nCependant une étude clinique randomisée en crossover sur 12 sujets sains recevant simultanément une dose de 200 mg de Ciclosporine (per os) avec 240 ml de jus de Canneberge (jus concentré) 1 fois/j durant 1 jour n\'a montré aucun effet sur la pharmacocinétique de la Ciclosporine (substrat du CYP3A4). Aucun effet sur l\'activité de l\'isoenzyme CYP3A4.\r\n\r\nAutre étude clinique randomisée en crossover sur 10 sujets sains recevant 200 ml de Canneberge (jus concentré dilué à l\'eau 1:4 vol/vol) 3 fois/j durant 10 j et une dose unique de 500 mg de Midazolam (per os) à J5 n\'a montré aucun effet sur la pharmacocinétique du Midazolam (substrat du CYP3A4).\r\nAucun effet sur l\'activité de l\'isoenzyme CYP3A4\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>1,
    'force_id'=>4,
    'notes'=>'Étude clinique randomisée en crossover sur 10 sujets sains recevant 200 ml de Canneberge (jus concentré dilué à l\'eau 1:4 vol/vol) 3 fois/jour durant 10 jours et une dose unique de 1 mg de Tizanidine (per os) à J5 n\'a montré aucun effet sur la pharmacocinétique de la Tizanidine (médicament substrat du CYP1A2).\r\nAucun effet sur l\'activité de l\'isoenzyme CYP1A2.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>595,
    'force_id'=>3,
    'notes'=>'Une étude chez le rat a évalué l\'activité diurétique d\'un extrait aqueux de Safran séché (stigmates). Extraits aqueux de Safran administrés oralement à des doses expérimentales de 60, 120 et 240 mg/kg et comparés à l\'Hydrochlorothiazide (puissant diurétique, 10 mg/kg par voie intrapéritonéale) comme témoin positif ou à un placebo (solution saline normale) comme groupe témoin.\r\nParamètres mesurés pour évaluer l\'activité diurétique étaient: volume total d\'urine, concentration de l\'urine en électrolytes (sodium, potassium), en créatinine et en urée.\r\nRésultats montrent que les rats traités avec l\'extrait aqueux de Safran avaient une production d\'urine plus élevée que le groupe témoin. De plus, les résultats ont montré une augmentation dose-dépendante significative de l\'excrétion des électrolytes en comparaison avec le groupe témoin.\r\nLes résultats ont prouvé l\'activité diurétique du Safran. \r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>45,
    'force_id'=>3,
    'notes'=>'Étude sur modèle de rat (2008) chez lequel une résistance à l\'insuline a été induite par un régime alimentaire riche en graisses. Rats traités avec Crocétine (caroténoïdes naturels du Safran), 50 mg/kg/j pendant 6 semaines. Résultats montrent que la Crocétine serait un agent de sensibilisation à l\'insuline.\r\n\r\nAutre étude in vitro (2007) sur des adipocytes de rat fraîchement isolés, a montré l\'effet de la Crocétine sur l\'amélioration de la sensibilité à l\'insuline (ici la résistance à l\'insuline dans les adipocytes a été induite par palmitate).\r\n\r\nThéoriquement, la prise concomitante de Safran et d\'un médicament hypoglycémiant peut potentialiser l\'effet hypoglycémiant\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>72,
    'force_id'=>3,
    'notes'=>'Sur la base d\'études sur modèle animal, des extraits aqueux de Safran (par voie intraveineuse) ont montré un effet hypotenseur chez des rats normotendus et hypertendus.\r\nEffet hypotenseur attribuable à 2 composants actifs de la plante (Crocine et Safranal)\r\n\r\nThéoriquement, la prise concomitante de Safran et de médicaments abaissant la tension artérielle peut potentialiser l\'effet hypotenseur.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>96,
    'force_id'=>3,
    'notes'=>'Une étude chez la souris a montré que l\'extrait aqueux de Safran et le Safranal (administrés par voie intrapéritonéale) présentent des effets anxiolytiques et hypnotiques.\r\n\r\nUne autre étude sur modèle animal (le rat) a montré que la Crocine avait des effets anxiolytiques.\r\n\r\nThéoriquement, la prise concomitante de Safran et de médicaments à visée anxiolytique/Hypnotique peut potentialiser leurs effets et augmenter l\'effet sédatif.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>21,
    'force_id'=>5,
    'notes'=>'Sur la base de preuves in vitro, un glucoconjugué de bulbes de Safran peut favoriser l\'activation des macrophages.\r\n\r\nUne autre étude in vitro, montre que la Crocine est un inhibiteur de l\'activation des cellules T.\r\n\r\nThéoriquement, le Safran semble moduler le système immunitaire et pourrait donc moduler l\'efficacité des traitements immunosuppresseurs/immunostimulants.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>45,
    'force_id'=>3,
    'notes'=>'Étude clinique (2007) croisée randomisée chez 68 patients atteints de diabète de type 2 et d\'hypercholestérolémie,  traités habituellement par Antidiabétiques oraux et hypolipédémiants (aucun n\'est spécifiquement nommé dans l\'étude), prenant un complément alimentaire contenant 360 mg/j de Lignanes de Lin (per os) pendant 12 semaines. Aucun effet significatif sur le profil lipidique, la résistance à l\'insuline, la glycémie à jeun et les concentrations en insuline. Une réduction mineure de l\'HbA1c, d\'environ 0,1 %, a eu lieu, bien que la signification clinique de cette réduction est susceptible d\'être minime.\r\nDans autre étude clinique (2008), la prise d\'huile de graines de lin (60 mg/kg/j d\'acide alpha-linolénique) n\'a pas montré d\'effet significatif sur le contrôle de la glycémie chez des patients atteints de diabète de type 2.\r\nCependant une autre étude (2002) chez 25 femmes ménopausées présentant une hypercholestérolémie, a montré une légère diminution de 5,3 % des taux de glucose sanguin suite à la prise de graines de lin écrasées.\r\n\r\nLes Graines de Lin ou l\'huile de graines de Lin peuvent réduire la glycémie. \r\nThéoriquement, la prise concomitante de Graines de Lin avec des médicaments hypoglycémiants  peut majorer l\'effet hypoglycémiant.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>604,
    'force_id'=>3,
    'notes'=>'Étude clinique réalisée chez 10 sujets sains, a montré qu\'une alimentation riche en huile de graines de Lin (20,5 g/j d\'acide alpha-linolénique) pendant 56 jours n\'avait pas d\'effet significatif sur les temps de saignement et le temps de prothrombine (1993).\r\nCependant une autre étude clinique chez 11 patients avec une polyarthrite rhumatoïde a rapporté que 30 g/j d\'huile de graines Lin pendant 3 mois (9,6 g par jour d\'acide alpha-linolénique) augmentait le temps de saignement d\'environ 1 minute par rapport à la ligne de base, bien que ces résultats n\'étaient pas statistiquement significatif (1995).\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>575,
    'force_id'=>5,
    'notes'=>'Les graines de Lin sont riches en lignanes. \r\n\r\nLes lignanes sont des phyto-œstrogènes ayant des propriétés agonistes ou antagonistes sur les récepteurs aux œstrogènes et peuvent théoriquement changer les niveaux d\'hormones dans l\'organisme et modifier l\'efficacité des traitements hormonaux et des pilules œstroprogestatives.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>605,
    'force_id'=>3,
    'notes'=>'Étude in vitro sur microsomes hépatiques humains a révélé la Mélisse comme étant un puissant inhibiteur du CYP450 de la voie de bioactivation du Tamoxifène (Substrat des isoenzymes CYP 3A4, CYP 2D6 et CYP 2C9).\r\n\r\nCes données suggèrent que la Mélisse pourrait empêcher la conversion métabolique de la prodrug en ces métabolites actifs,  provoquant un sous-dosage et de ce fait un impact clinique négatif par réduction de l\'efficacité de la thérapie.',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>73,
    'force_id'=>3,
    'notes'=>'L\'huile d\'Onagre pourrait inhiber l\'agrégation plaquettaire et augmenter le temps de saignement.\r\n\r\nÉtude clinique (1994) chez 12 patients avec une hyperlipidémie et prenant de l\'Huile d\'Onagre (3g/j) pendant 4 mois, a montré une diminution de l\'agrégation plaquettaire et une augmentation de 40 % du temps de saignement. L\'huile d\'Onagre a été donnée sous la forme de  6 capsules molles (per os) de 500 mg /j. La dose journalière contenait 2,2 g d\'acide linoléique et 240 mg d\'acide gamma-linolénique.\r\n\r\nRésultats similaires chez des animaux ayant reçu l\'Huile d\'Onagre ou de l\'Acide gamma-linolénique (1994, 1997).\r\n\r\nLes résultats d\'une autre étude clinique (2009) suggèrent que l\'huile d\'onagre possède une activité anticoagulante et antiplaquettaire considérable chez les animaux.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>3,
    'force_id'=>3,
    'notes'=>'Dans une étude in vitro (2002 Aug), l\'acide Cis-linoléique (constituant de l\'huile d\'Onagre) s\'est révélé être un inhibiteur modéré du CYP2C9 (principal  isoenzyme impliqué dans le métabolisme de la Warfarine). Cependant il était 26 fois moins puissant que le Sulfaphénazole, un médicament connu pour avoir révélé cliniquement des effets inhibiteurs sur le CYP2C9 in vivo.\r\nIl semble peu probable que l\'huile d\'Onagre modifie la pharmacocinétique (in vivo) de la Warfarine. Les autres coumarines, métabolisées par une voie similaire à la Warfarine, sont donc également peu susceptibles d\'être affectées. \r\nCependant sur la base de l\'effet antiagrégant plaquettaire potentiel de l\'Huile d\'Onagre, il est suggéré que les patients prenant des Anticoagulants devrait utiliser l\'Huile d\'Onagre avec prudence voire même l\'éviter.\r\n\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
...
Hinteraction::create( [
    ...
    'target_id'=>606,
    'force_id'=>2,
    'notes'=>'Homme de 47 ans séropositif prenant : Lopinavir boosté par Ritonavir 533/133 mg 2 fois/j, Tenofovir 245 mg/j et Lamivudine 150 mg 2 fois/j.\r\nIl a développé une diarrhée persistante (épisodes diarrhéiques se produisant plus de 5 fois/j) et un niveau élevé de Lopinavir de 15,2 mg/L (soit une augmentation de 56 %) après avoir consommé de l\'huile d\'Onagre et un complément contenant Aloès, Rhubarbe, Réglisse et Menthe Poivrée.\r\nLe niveau de Lopinavir est retourné à la normale (5 à 10 mg/L) 6 semaines après l\'arrêt de toutes les préparations à base de plantes.\r\nLe patient a reconsommé de l\'huile d\'Onagre pendant 1 semaine et le niveau de Lopinavir est passé de 6,69 mg/L à 8,11 mg/L, sans effets indésirables rapportés.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>608,
    'force_id'=>3,
    'notes'=>'Dans étude contrôlée par placebo (1983) : 8 patients ont reçu des capsules d\'EFAMOL (Huile d\'onagre fournissant 329 mg d\'acide linoléique et 58 mg acide gamma-linolénique + Vitamine E 7,5 UI) en plus de leur traitement habituel (Phénothiazines pour schizophrénie) dont 3 patients ont développé des crises d\'épilepsie. \r\nDans autre étude (1981), 3 patients schizophrènes de longue date prenant de l\'huile d\'Onagre ont été hospitalisés pour une aggravation de leur schizophrénie et leur EEG mettait en évidence une épilepsie du lobe temporal.\r\nEn revanche, aucune convulsion épileptiforme ni autre événement n\'ont été rapportés dans une étude croisée (1989) chez 48 patients prenant des phénothiazines lors de la prise d\'Huile d\'Onagre pendant 4 mois.\r\nMécanisme inconnu. L\'huile d\'onagre semble éventuellement augmenter les effets épileptogénes bien reconnus des Phénothiazines.',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>590,
    'force_id'=>3,
    'notes'=>'L\'huile d\'Onagre peut éventuellement augmenter les effets épileptogènes bien reconnus des Phénothiazines.\r\n\r\nL\'interaction entre l\'Huile d\'Onagre et les Phénothiazines n\'est pas très bien établie et son incidence n\'est pas connue mais une certaine prudence doit être adoptée en cas d\'utilisation concomitante car des crises d\'épilepsies se sont produites chez quelques patients.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>575,
    'force_id'=>5,
    'notes'=>'Le Houblon contient des composés œstrogéniques (phyto-oestrogènes). \r\nDes effets œstrogéniques ou anti-oestrogéniques ont été rapportés in vitro et in vivo. \r\nIl peut théoriquement interagir avec les œstrogènes ou les antagonistes aux œstrogènes.\r\nAssociation déconseillée\r\n\r\n\r\n\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>3,
    'notes'=>'Étude in vitro (2006) sur des extraits alcooliques de Prêle des champs a montré un faible effet inhibiteur sur l\'isoenzyme CYP3A4 du Cytochrome P450.\r\n\r\nL\'inhibition in vivo du cytochrome hépatique CYP3A4 semble peu probable (2014).\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>3,
    'notes'=>'Dans étude in vitro, 4 extraits d\'Orthosiphon (contenant les principaux constituants actifs : Sinensétine, Eupatorine ou Acide rosmarinique) ont été testés.\r\nUne inhibition modérée de l\'activité du CYP3A4 a été montré par les extraits de dichlorométhane et d\'éther de pétrole, mais pas par des extraits aqueux ou le méthanol, et une forte inhibition a été démontré par l\'Eupatorine.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>5,
    'notes'=>'Démontré seulement in vitro (2007 Jan).\r\n\r\nD\'autres études in vitro (2007 Nov, 2008 May) ont constaté que la Sauge n\'inhibe pas le CYP3A4 hépatique bien qu\'il peut y avoir un effet cliniquement significatif sur le CYP3A4 intestinal.\r\n\r\nEn revanche une autre étude in vitro (2003 May) a montré que la Sauge avait des effets inhibiteurs sur le CYP3A4 mais ces résultats doivent être interprétés avec prudence car cette étude a trouvé que le Millepertuis est un inhibiteur du CYP3A4, alors que cliniquement, il est inducteur du CYP3A4.',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>609,
    'force_id'=>3,
    'notes'=>'Une étude sur des rats a décrit une addition d\'effet sédatif lorsqu\'un extrait de Passiflore (250mg/kg) a été administré avec le Phénobarbital injectée par voie sous-cutanée (35mg/kg) (paramètre évalué par une augmentation de 53 % de la durée du sommeil).\r\nBien qu\'il s\'agisse d\'une étude à dose élevée chez l\'animal, ces résultats semblent être en corrélation avec les effets sédatifs connus de la Passiflore.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>610,
    'force_id'=>1,
    'notes'=>'Un cas rapporté chez un homme de 40 ans décrit une possible interaction entre le Lorazépam et des extraits de plantes : Valeriana officinalis et Passiflora incarnata.\r\nCe patient prenait du Lorazépam (2 mg/24h) depuis 2 mois sans le moindre effet secondaire. \r\nPuis pendant 2 jours il ajouta : 2h avant le coucher, la prise d\'une infusion contenant des parties souterraines (racines et rhizomes) de Valériane et juste avant d\'aller au lit, le patient a pris la même infusion mélangée avec des parties aériennes séchées de Passiflore. La dose estimée pour l\'infusion était de 300 mg. Tout cela sans effet secondaire. \r\nLe 3ème jour, au lieu de prendre une infusion, le patient a pris une dose similaire des mêmes plantes mais sous formes de comprimés. Chaque comprimé contenait 300 mg de Valériane (extrait sec de parties souterraines) et 380 mg de Passiflore (extrait sec de parties aériennes) selon l\'étiquette du produit. Le patient a pris 3 comprimés à 1h d\'intervalle avant le coucher. Le patient a ressenti une forte somnolence.\r\nLe 4ème jour, le même traitement par les plantes a été répété et le patient a décrit des effets secondaires tels que vertiges, tremblements, fatigue musculaire, palpitations avant d\'aller au lit suivis d\'une forte somnolence avant de s\'endormir.\r\nL\'examen clinique et physique, les antécédents médicaux personnels et familiaux du patient ont exclu toute cause pouvant être responsable de ces symptômes.\r\nLes symptômes ont disparu lorsque le patient a arrêté le traitement à base de plantes.\r\nUn effet additif ou synergique sur le SNC avec le Lorazépam est soupçonné d\'avoir produit ces symptômes. \r\nLes principes actifs de la Valériane et Passiflore pourraient augmenter l\'activité inhibitrice des Benzodiazépine sur les Rx GABA ce qui provoque des effets secondaires graves.',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>611,
    'force_id'=>1,
    'notes'=>'Patiente de 26 ans, prenant depuis 5 mois 900 mg de Lithium 2 fois/j avec de l\'Hydroxyzine, du Lorazépam, du Propranolol, la Rispéridone et de la Sertraline, s\'est rendu en urgence à la clinique avec les symptômes suivants : nausées, diarrhées, démarche instable, tremblements, nystagmus et somnolence (symptômes révélant une toxicité au Lithium). Son niveau de Lithium, qui était stable à 1,1 mmol/L, est passé à 4,5 mmol/L.\r\nA l\'interrogatoire, la patiente signala qu\'elle prenait depuis les 2-3 dernières semaines, un complément alimentaire à base de plantes à visée diurétique (dont l\'Equisetum hyemale).\r\nL\'explication la plus probable sur l\'intoxication au Lithium reste ce complément alimentaire à base de plantes. Cependant, il est impossible de savoir quelle plante ou combinaison de plante est responsable de cette toxicité.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>45,
    'force_id'=>5,
    'notes'=>'La Prêle pourrait diminuer la glycémie chez les personnes atteintes de diabète de type 2. \r\nLa prise concomitante avec des antidiabétiques peut théoriquement majorer le risque d\'hypoglycémie.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>37,
    'force_id'=>5,
    'notes'=>'La Prêle par son pouvoir diurétique peut diminuer la quantité de potassium dans l\'organisme (effet hypokaliémiant).\r\n\r\nLa prise concomitante de la Prêle et d\'un diurétique hypokaliémiant peut théoriquement potentialiser l\'effet diurétique et augmenter le risque de perte de potassium et donc d\'hypokaliémie.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>96,
    'force_id'=>3,
    'notes'=>'La Sauge semble avoir un effet sédatif.\r\n \r\nThéoriquement,  la prise concomitante avec les médicaments tels que les sédatifs, les hypnotiques, les anxiolytiques et les dépresseurs du SNC potentialise le risque de dépression du SNC et de somnolence.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>8,
    'force_id'=>3,
    'notes'=>'Démontré in vivo chez des rats.\r\n\r\nLes effets de l\'administration concomitante de compléments alimentaires à base de Biochanine A (un important constituant du Trèfle rouge, 100 mg/kg per os) sur la pharmacocinétique de la Glycoprotéine-P à partir de 3 substrats : Digoxine (20mg/kg per os), Fexofénadine (20mg/kg per os) et Paclitaxel (20 mg/kg per os) ont été étudiés chez des rats. \r\nLes résultats montrent une inhibition modeste de la Glycoprotéine-P par Biochanine A.',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>590,
    'force_id'=>5,
    'notes'=>'L\'huile essentielle de Sauge peut diminuer le seuil épileptogène et provoquer des convulsions du fait d\'une haute teneur en Thuyone.\r\n\r\nUne activité convulsivante chez l\'Homme (et les animaux) a été documentée pour l\'Huile essentielle de Sauge.\r\n\r\nLa prise concomitante d\'huile essentielle de Sauge et d\'Antiépileptiques peut théoriquement diminuer l\'efficacité de ces médicaments.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>575,
    'force_id'=>5,
    'notes'=>'Les graines de Soja sont riches en phyto-œstrogènes  (Isoflavones : génistéine et diadzéine).\r\n\r\nCes phyto-œstrogènes semblent avoir des propriétés agonistes ou antagonistes sur les récepteurs aux œstrogènes et peuvent théoriquement changer les niveaux d\'hormones dans l\'organisme et modifier l\'efficacité des traitements hormonau\r\nAssociation déconseillée théoriquement\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>614,
    'force_id'=>3,
    'notes'=>'Une étude in vitro suggère que les compléments à base de Soja pourraient annuler l\'action inhibitrice des inhibiteurs de l\'aromatase et donc modifier l\'efficacité de ces médicaments utilisés dans le traitement du cancer du sein.\r\n\r\nExemples d\'inhibiteurs de l\'aromatase :\r\nAnastrozole, Exemestane, Létrozole.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>615,
    'force_id'=>3,
    'notes'=>'Les effets de la Biochanine A sur la pharmacocinétique de la Digoxine ont été étudiés chez le rat.\r\n\r\nLa Digoxine est substrat de la P-gp. La Biochanine A peut inhiber la glycoprotéine-P résultant en une augmentation modérée de la biodisponibilité orale de la Digoxine.\r\n\r\nToutefois, en raison de l\'indice thérapeutique étroit de la Digoxine, il peut être prudent de faire preuve de précaution d\'emploi si les patients prenant de la Digoxine souhaitent également prendre un complément contenant de fortes doses de Biochanine A.\r\n\r\nÊtre attentif à toute preuve d\'effet indésirable de la Digoxine et surveiller les niveaux de Digoxine.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>617,
    'force_id'=>3,
    'notes'=>'Les effets de la Biochanine A sur la pharmacocinétique de la Féxofénadine ont été étudiés chez le rat.\r\n\r\nLa Féxofénadine est substrat de la P-gp. La Biochanine A semble inhiber la glycoprotéine-P dans l\'intestin conduisant à l\'absorption orale diminuée de la Féxofénadine.\r\n\r\nCependant, il ne semble pas y avoir de données cliniques concernant une interaction entre Biochanine A et Féxofénadine et la pertinence clinique des données expérimentales doit être déterminée.\r\nToutefois, la modeste réduction de la biodisponibilité de la Féxofénadine suggère qu\'une interaction cliniquement importante est peu probable. \r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>575,
    'force_id'=>4,
    'notes'=>'Les principaux isoflavones (phyto-œstrogènes) présents dans le Trèfle rouge comprennent Biochanine A, Formononétine, Génistéine et Diadzéine. \r\n\r\nLes phyto-oestrogènes présents dans le Trèfle rouge ont des propriétés agonistes ou antagonistes sur les récepteurs aux œstrogènes  et peuvent théoriquement changer les niveaux d\'hormones dans l\'organisme et modifier l\'efficacité des traitements hormonaux et des pilules œstroprogestatives.\r\n\r\nDes extraits méthanolique de Trèfle rouge ont montré significativement une liaison aux Récepteurs alpha et bêta des oestrogènes. \r\n\r\nUn extrait de Trèfle rouge a montré des effets faiblement œstrogéniques dans un modèle de rat ovariectomisé et a montré in vitro une capacité de liaison aux Récepteurs alpha et bêta des oestrogènes.\r\n\r\nL\'efficacité clinique n\'a pas cependant été démontrée\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>619,
    'force_id'=>5,
    'notes'=>'Femme de 39 ans avait pris pendant 2 mois une dose quotidienne de 2 comprimés d\'une préparation de Millepertuis et un comprimé de racines de Valériane.\r\nElle a été hospitalisée suite à la prise de Lopéramide (pour des diarrhées) et présentait un Delirium grave. Les symptômes disparaissent 2 jours après l\'arrêt des plantes.  Les auteurs proposent une interaction entre le traitement à base de plantes et le Lopéramide en impliquant des propriétés inhibitrices de la MAO.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>620,
    'force_id'=>3,
    'notes'=>'La Valériane a un effet sédatif et une activité dépressive sur le SNC.\r\n\r\nDans une étude chez la souris, l\'acide valérénique (constituant actif de la valériane), 50 à 100 mg/kg s\'est avéré augmenté la sédation, mais seulement aux doses les plus élevées. L\'effet était le plus fort 10 à 15 minutes après l\'administration. Le Pentobarbital, 60 mg/kg, a aussi sédaté la souris mais les effets étaient plus prononcés que ceux avec de l\'acide valérénique.\r\nLorsque les 2 substances étaient données ensemble, l\'acide valérénique prolongeait le temps de sommeil en réponse à Pentobarbital. L\'effet était dose-dépendant, avec la dose la plus forte d\'acide valérénique, le temps de sommeil avait quasiment doublé.\r\n\r\nL\'acide valérénique a des propriétés non spécifiques dépresseurs du SNC qui semblent renforcer les effets du Pentobarbital.\r\n\r\nLa preuve d\'une interaction entre l\'acide valérénique et le Pentobarbital se limite à cette seule étude chez la souris, cependant les effets sont en corrélation avec les activités connues de ces 2 substances.\r\n\r\nLes autres barbituriques (ex: Phénobarbital) ne semblent pas avoir été étudiés, mais il semble probable qu\'ils vont agir de manière similaire. \r\n\r\nIl peut donc être prudent de considérer les effets potentiels additifs sédatifs lors d\'une prise concomitante de barbituriques et de Valériane.\r\n\r\nAssociation déconseillée théoriquement.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>621,
    'force_id'=>5,
    'notes'=>'Une étude clinique suggère que la Valériane n\'a pas d\'effet cliniquement significatif sur la pharmacocinétique de la Caféine.\r\n\r\nToutefois, les effets stimulants de la Caféine peuvent théoriquement s\'opposer aux effets hypnotiques de la Valériane et donc diminuer son efficacité comme sédatif.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>622,
    'force_id'=>5,
    'notes'=>'Une étude in vivo chez le rat a été menée sur les interactions entre une teinture de racines de Valériane (éthanol 100 %, 1 : 10) à une dose thérapeutique quotidienne de 3060 mg et l\'Halopéridol (38 mg/kg) administré par voie IM une fois toutes les 4 semaines pendant 12 semaines, débuté après 15 jours de traitement avec la Valériane.\r\nLes auteurs ont conclu que chez l\'homme un éventuel effet additif toxique se produirait seulement à des doses supra-thérapeutiques.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>5,
    'force_id'=>3,
    'notes'=>'Démontré in vivo par  étude clinique sur 42 sujets recevant 2x500mg 1 fois/jour pdt 28 jours (comprimé contenant 500mg de resvératrol et des excipients inertes). Augmentation de 70% (p=0.01) du rapport moléculaire Dextromethorphane/dexthorphane.\r\nInhibition de CYP2D6.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>3,
    'force_id'=>1,
    'notes'=>'Démontré in vivo par étude clinique sur 42 sujets recevant 500mg d\'extrait sec 1 fois/jour pdt 28 jours des capsules contenant 500mg de resvératrol et des excipients inertes. \r\nAugmentation de 171% (p<0.0001) de l\'index phénotypique du Losartan. \r\nInhibition du CYP2C9.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>73,
    'force_id'=>3,
    'notes'=>'La vigne rouge contient du resvératrol.\r\n\r\nDes études suggèrent que le resvératrol réduit l\'agrégation plaquettaire.\r\n\r\nCet effet peut être théoriquement additif à l\'effet antiagrégant plaquettaire des Anticoagulants/Antiagrégants plaquettaires et peut augmenter le risque de saignement.\r\n\r\nAssociation déconseillée théoriquement.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>575,
    'force_id'=>3,
    'notes'=>'Le Gattilier, plante à action œstrogénique, semble modifier les niveaux d\'hormones dans l\'organisme. \r\nAinsi une prise concomitante de Gattilier et d\'un traitement hormonal peut théoriquement diminuer l\'efficacité du traitement et/ou augmenter les effets secondaires (nausées, maux de tête, tension mammaire).\r\n\r\nDes effets œstrogéniques ont été rapportés in vitro (2001, 2003, 2004 et 2006) et dans un Case report (1994).\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>72,
    'force_id'=>5,
    'notes'=>'Le Gatillier potentialise théoriquement les effets des Antihypertenseurs.\r\nRisque majoré d\'hypotension.',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>624,
    'force_id'=>5,
    'notes'=>'Études in vitro (2000, 2011) ont montré que les constituants et extraits de Gattilier avaient une affinité pour les récepteurs opioïdes.\r\nDans une étude (2000), des extraits lipophiles de Gattilier ont produit une inhibition de la liaison aux récepteurs mu- et kappa-opioïdes et une fraction aqueuse a produit une inhibition de la liaison aux récepteurs delta-opioïdes.\r\nDans une autre étude (2011), différents extraits ont montré qu\'ils se liaient et activaient les récepteurs mu- et delta-opioïdes mais pas les récepteurs kappa-opioïdes.\r\nUne étude sur des cellules ovariennes animales (2006) a révélé que des extraits de Gattilier agissaient comme des agonistes des récepteurs mu-opioïdes de manière similaire à la morphine (agoniste opioïde).\r\n\r\nExemples de médicaments opioïdes : \r\nBuprénorphine, Codéine, Dihydrocodéine, Fentanyl, Morphine, Oxycodone, Tramadol.\r\n',
    'user_id'=>43,
    'validated'=>1
    ] );
    ...
    'target_id'=>3,
    'force_id'=>2,
    'notes'=>'In vitro, les extraits éthanolique et méthanolique d\'Andrographis paniculata (AP) ont des effets inhibiteurs modérés sur l\'activité du CYP2C9 (inhibition non compétitive, IC 50 =41.3µg/ml et 76.7µg/ml respectivement)\r\nL\'extrait aqueux et d\'hexane d\'AP ont des effets inhibiteurs relativement faibles sur l\'activité du CYP2C9\r\nAndrographolide n\'inhibe pas de manière significative l\'activité du CYP2C9\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>1,
    'force_id'=>11,
    'notes'=>'L\'o-methoxycinnamaldehyde (OMCA) extrait du Cortex cinnamomi a inhibé l\'oxydation de phenacétine par le CYP1A2 dans les microsomes de rats et humains (Ki = 13.7 µM et Ki =16µM respectivement). Inhibition compétitive.\r\nLa formation d\'acide o-methoxycinnamique (OMC acid) à partir d\'OMCA  par CYP2E1 est plus importante que par CYP1A2, suggérant que OMCA est plus un substrat pour CYP2E1 que pour CYP1A2.\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>7,
    'force_id'=>11,
    'notes'=>'L\'o-methoxycinnamaldehyde (OMCA) extrait du Cortex cinnamomi  a inhibé l\'oxydation de 4-nitrophenol par le CYP2E1 dans les microsomes de rats et humains (Ki = 6.3 µM et Ki =7.7µM). Inhibition mixte\r\n\r\nLa formation d\'acide o-methoxycinnamique (OMC acid) à partir d\'OMCA  par CYP2E1 est plus importante que par CYP1A2, suggérant qu\' OMCA est plus un substrat pour CYP2E1 que pour CYP1A2.\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>637,
    'force_id'=>11,
    'notes'=>'In vitro, inhibition significative par les flavonoïdes et les terpenoïdes\r\nIC50= 2.06 +/- 0.03 ',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>74,
    'force_id'=>3,
    'notes'=>'Oralement, la feuille d\'Eucalyptus peut causer des effets gastro-intestinaux.\r\nEtude randomisée, en double-aveugle, contrôlée par placebo sur 242 patients atteint d\'une obstruction pulmonaire chronique recevant soit un placebo soit 200 mg de cinéole 3*/j comme traitement concomitant pendant 6 mois, seulement 3 patients s/110 ont des nausées, diarrhées et brûlures d\'estomac. \r\n(Feuilles sèches contiennent 1-3.5% d\'huile essentielle (HE). L\'HE contient 54 à 95% de 1.8- cinéole).\r\n',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>36,
    'force_id'=>11,
    'notes'=>'Etude en double aveugle, randomisée, contrôlée par placebo, en crossover sur 46 patients en surpoids recevant, sur 12 sem., des capsules de polyphénols extraits des feuilles d\'olivier (51.1 mg oleuropeine, 9.7 mg hydroxytyrosol /j). Pas de modification de la fonction hépatique (AST, ALP, ALT, GGT)\r\nAltérations hépatiques constatées chez des rats nourris avec une alimentation enrichie par un extrait de feuilles d\'Olivier',
    'user_id'=>30,
    'validated'=>1
    ] );
    ...
    'target_id'=>2,
    'force_id'=>5,
    'notes'=>'1-l\'extrait de pépins de raisin et le thé vert ont été confirmés comme des inhibiteurs puissants du métabolisme médié par le CYP3A4 de plusieurs substrats (7-benzyloxy-4-trifluorométhyl-coumarine (BFC), midazolam et docétaxel).\r\n2-des essais in vitro, ont affirmé  que l\'extrait de pépins de raisin a produit une augmentation de 200 à 400% de l\'ARNm du CYP3A4 des hépatocytes supérieure à celle des cellules traitées au DMSO.',
    'user_id'=>152,
    'validated'=>0
    ] );
