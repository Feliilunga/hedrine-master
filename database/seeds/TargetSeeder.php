...
class TargetSeeder extends Seeder
{
    ...
    public function run()
    {
        Target::create( [
            ...
            'id'=>18,
            'name'=>'CYP2A6',
            'long_name'=>'cytochrome P450 isoforme 6',
            'target_type_id'=>2,
            'notes'=>'',
            'user_id'=>2,
            'validated'=>1
...
Target::create( [
    ...
    'id'=>27,
    'name'=>'MRP-1',
    'long_name'=>'Multidrug Resistance Protein 1',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    'id'=>28,
    'name'=>'MRP-2',
    'long_name'=>'Multidrug Resistance Protein 2',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    'id'=>29,
    'name'=>'CYP3A7',
    'long_name'=>'cytochrome P450 isoforme 3A7',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>30,
    'name'=>'Etude in vitro (Gui + doxo)',
    'long_name'=>'Etude in vitro  (Gui + doxo) Exacerbation de la cytotoxicité observé sur la lignée cellulaire humaine Jurkat (lymphome)',
    'target_type_id'=>3,
    'notes'=>'Exacerbation de la cytotoxicité',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>31,
    'name'=>'Etude sur modèle murin (Astragales + Cyclophosphamide)',
    'long_name'=>'Etude sur modèle murin (Astragales + Cyclophosphamide)',
    'target_type_id'=>6,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>32,
    'name'=>'Etude sur modèle murin (Actee + cispt)',
    'long_name'=>'Etude sur modèle murin (Actee + cispt)',
    'target_type_id'=>6,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    'id'=>33,
    'name'=>'Artériopathie',
    'long_name'=>'Association entre des plantes contenant des molÃ©cules vasoconstrictives et un traitement vasoconstricteur est dÃ©conseillÃ©e',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    'id'=>35,
    'name'=>'SIADH',
    'long_name'=>'Risque accru de syndrome de sécrétion inappropriée d\'hormone anti-diurétique',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    'id'=>36,
    'name'=>'Hépatotoxicité',
    'long_name'=>'Association entre des plantes hépatoxiques et un traitement hépatoxique est théoriquement déconseillée',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    'id'=>37,
    'name'=>'Kaliémie',
    'long_name'=>'Association entre des plantes modifiant la kaliémie et un traitement modifiant la kaliémie est théoriquement déconseillée',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>38,
    'name'=>'Allongement de l espace QT',
    'long_name'=>'Risque accru de prolongation de l\'espace QT théorique',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>39,
    'name'=>'Etude sur modèle murin (Chardon + cisPt)',
    'long_name'=>'Etude sur modèle murin (Chardon + cisPt)',
    'target_type_id'=>6,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>40,
    'name'=>'Case report (Panax ginseng + Imatinib)',
    'long_name'=>'Cas relatant un risque accru d\'hépatotoxicité  (Panax ginseng + Imatinib)',
    'target_type_id'=>1,
    ...
    Target::create( [
    'id'=>41,
    'name'=>'Etude clinique (Gingko + 5-FU)',
    'long_name'=>'Etude en phase II (Gingko + 5-FU)',
    'target_type_id'=>4,
    'notes'=>'Dans un cas clinique en phase II une augmentation AUC du 5-FU a été décrite Des études cliniques suggèrent que des extraits de ginkgo i.v. (EGb 761, Tanakan, Ipsen) co-administrés avec 5-fluorouracile pourraient être bénéfiques dans le cas d\'un cancer du colon métastatique?',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'id'=>42,
    'name'=>'Pancytopénie',
    'long_name'=>'Majore le risque de pancytopenie',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    'id'=>45,
    'name'=>'Glycémie',
    'long_name'=>'Association entre des plantes hypo/hyperglycémiantes et un traitement modifiaant la glycémie est théoriquement déconseillée',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>44,
    'name'=>'Etude clinique (Gui + Gemcitabine), étude en phase 1',
    'long_name'=>'Etude clinique sur patient en stade IV (Gui + Gemcitabine), étude en phase 1',
    'target_type_id'=>4,
    'notes'=>'Etude clinique sur patient en stade IV: observation l\'influence d\'une thérapie gui (sc) sur la concentration plasmatique de gemcitabine durant le traitement. Le gui n\'a pas influencé les concentrations de gemcitabine. ',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>46,
    'name'=>'Etude sur modèle murin (Actee a grappe + doxorubicine/docetaxel)',
    'long_name'=>'Etude sur modèle murin (Actee a grappe + doxorubicine/docetaxel)',
    'target_type_id'=>6,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>47,
    'name'=>'Etude clinique (Actee+Tamox)',
    'long_name'=>'Etude clinique (Actee+Tamox)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>48,
    'name'=>'Etude sur modèle murin (poivre+docetaxel)',
    'long_name'=>'Etude sur modèle murin (poivre+docetaxel)',
    'target_type_id'=>6,
    'notes'=>'étude sur xenogrefe de souris',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'id'=>49,
    'name'=>'INR',
    'long_name'=>'Risque de modification de l\'INR',
    'target_type_id'=>5,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>51,
    'name'=>'Etude in vitro (Thé+bortezomib)',
    'long_name'=>'Etude in vitro (Thé+bortezomib)',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>0
    ...
    Target::create( [
    'id'=>52,
    'name'=>'Etude sur modèle murin (Réglisse+Cisplatine)',
    'long_name'=>'Etude sur modèle murin (Réglisse+Cisplatine)',
    'target_type_id'=>6,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>53,
    'name'=>'Etude sur modèle murin (Chardon Marie+Tamoxifène)',
    'long_name'=>'Etude sur modèle murin (Chardon Marie+Tamoxifène)',
    'target_type_id'=>6,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>55,
    'name'=>'Etude clinique (Millepertuis + SN-38 ou irinotecan)',
    'long_name'=>'Etude clinique (Millepertuis + SN-38 ou irinotecan)',
    'target_type_id'=>4,
    'notes'=>'L\'utilisation concomitante avec le millepertuis peut diminuer les concentrations sériques de l\'irinotécan d\'au moins 50%. La clairance du métabolite actif de l\'irinotécan, le SN-38, est augmentée, entraînant une diminution de 42% de l\'aire sous la courbe.',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>57,
    'name'=>'Etude clinique (Millepertuis+Medroxyprogesterone)',
    'long_name'=>'Etude clinique (hypericum+medroxyprogesterone)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>58,
    'name'=>'Case report (Millepertuis + Thalidomide)',
    'long_name'=>'Case report (Millepertuis + Thalidomide)',
    'target_type_id'=>1,
    ...
    Target::create( [
    'id'=>59,
    'name'=>'Case report (Chanvre+Irinotecan+docetaxel)',
    'long_name'=>'Case report (Chanvre+Irinotecan+docetaxel)',
    'target_type_id'=>1,
    ...
    Target::create( [
        'id'=>63,
        'name'=>'Case report (ginseng+imatinib)',
        'long_name'=>'Case report (ginseng+imatinib)',
        'target_type_id'=>1,
        'notes'=>'Case report avec addition de la toxicité hépatique',
        'user_id'=>2,
        'validated'=>1
        ...
        Target::create( [
        'id'=>64,
        'name'=>'Etude clinique (pomélo+nilotinib)',
        'long_name'=>'Etude clinique (pomélo+nilotinib)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>65,
        'name'=>'Case report (Pomélo+docetaxel)',
        'long_name'=>'Case report (Pomélo+docetaxel)',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>67,
        'name'=>'Etude Clinique (chardon + irinotecan)',
        'long_name'=>'Etude Clinique sur 6 patients (chardon + irinotecan)',
        'target_type_id'=>4,
        'notes'=>'200 mg de Chardon-Marie 3 fois par j pendant 4 ou 12 jours n\'a pas d\'effet sur la pharmacocinétique de l\'irinotecan ',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        Target::create( [
        'id'=>69,
        'name'=>'Case report (Echinacée+etoposide)',
        'long_name'=>'Case report (Echinacée+etoposide)',
        'target_type_id'=>1,
        'notes'=>'Thrombocytopénie probable chez un patient de 61 ans',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'id'=>71,
        'name'=>'Néphrotoxicité',
        'long_name'=>'Association entre des plantes néphrotoxiques et un traitement néphrotoxique est théoriquement déconseillée',
        'target_type_id'=>3,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'long_name'=>'Association d\'un médicament anti-hypertenseur ou modifiant la tension artérielle et d\'une plante avec la même indication ou le même effet indésirable est déconseillée',
        'target_type_id'=>3,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'id'=>73,
        'name'=>'Hémorragie',
        'long_name'=>'L\'association d\'une plante thrombogène ou fluidifiant le sang et un médicament thrombopéniant est théoriquement déconseillée',
        'target_type_id'=>3,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        Target::create( [
        'id'=>74,
        'name'=>'Toxicité digestive',
        'long_name'=>'Risque d\'accumulation de la toxicité digestive',
        'target_type_id'=>3,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        Target::create( [
        'id'=>77,
        'name'=>'Etude Clinique (Millepertuis + Répaglinide)',
        'long_name'=>'Etude Clinique (hypericum+répaglinide)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>79,
        'name'=>'Etude clinique (ginkgo + omeprazole)',
        'long_name'=>'Etude sur volontaires sains (ginkgo + omeprazole)',
        'target_type_id'=>4,
        ...
        'id'=>80,
        'name'=>'MRP-3',
        'long_name'=>'Multidrug Resistance Protein 3',
        'target_type_id'=>2,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'id'=>81,
        'name'=>'MRP-4',
        'long_name'=>'Multidrug Resistance Protein 4',
        'target_type_id'=>2,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        Target::create( [
        'id'=>86,
        'name'=>'Etude Clinique (gui+5-FU, doxifluridine) ',
        'long_name'=>'Etude Clinique (gui+5-FU, doxifluridine) ',
        'target_type_id'=>4,
        'notes'=>'Étude sur 32 patients avec un cancer gastrique (stage Ib or II) après exérèse et durant le traitement par 5-FU et doxifluridine. Le gui a été administré du jour 7 à la semaine 24 en augmentant les doses. Pas d\'interaction médicamenteuse. Etude clinique (Registration number NCT01401075)',
        'user_id'=>2,
        'validated'=>1
        ] );
        ...
        'id'=>83,
        'name'=>'MRP-6',
        'long_name'=>'Multidrug Resistance Protein 6',
        'target_type_id'=>2,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'id'=>84,
        'name'=>'MRP-5',
        'long_name'=>'Multidrug Resistance Protein 5 ',
        'target_type_id'=>2,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'id'=>85,
        'name'=>'MRP-7',
        'long_name'=>'Multidrug Resistance Protein 7',
        'target_type_id'=>2,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'id'=>87,
        'name'=>'Thrombogène',
        'long_name'=>'L\'association d\'une plante thrombogène ou fluidifiant le sang et un médicament thrombogène est théoriquement déconseillée',
        'target_type_id'=>3,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'id'=>88,
        'name'=>'OAT',
        'long_name'=>'Organic Anion Tranporteur',
        'target_type_id'=>2,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
        ...
        'id'=>89,
        'name'=>'OCT',
        'long_name'=>'Organic Cation Transporteur',
        'target_type_id'=>2,
        'notes'=>'',
        'user_id'=>2,
        'validated'=>1
...
Target::create( [
    ...
    Target::create( [
    'id'=>91,
    'name'=>'Etude clinique (Millepertuis+fexofenadine)',
    'long_name'=>'Etude clinique (hypericum+fexofenadine)',
    'target_type_id'=>4,
    'notes'=>'Etude sur volonataires sains avec une dose unitaire sur 15 jours',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    'id'=>96,
    'name'=>'Sédation',
    'long_name'=>'l\'association d\'une plante sédative et d\'un médicamant induisant une sédation sont susceptible d\'interagir',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>99,
    'name'=>'Etude sur modèle murin (curcuma+acide mycophénolique)',
    'long_name'=>'Etude sur modèle murin (curcuma+acide mycophénolique)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>102,
    'name'=>'Etude sur modèle murin (Schisandra+ciclosporine)',
    'long_name'=>'Etude sur modèle murin (Schisandra+ciclosporine)',
    'target_type_id'=>6,
    ...
    'long_name'=>'',
    'target_type_id'=>3,
    'notes'=>'L\'association d\'une plante et d\'une DCI induisant un syndrome sérotoninergique est à proscrire',
    'user_id'=>2,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>107,
    'name'=>'Case report (Ginseng sibérien + digoxine)',
    'long_name'=>'Cas d\'augmentation de la digoxinémie (Ginseng sibérien + digoxine)',
    'target_type_id'=>1,
    'notes'=>'1 rapport de cas d\'augmentation de la digoxinémie suite à la consommation d\'éleuthérocoque chez un patient préalablement stable sous Digoxine',
    'user_id'=>3,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>108,
    'name'=>'Case report  (Gingembre + warfarine)',
    'long_name'=>'Cas d\'augmentation de l\'INR (Gingembre + warfarine)',
    'target_type_id'=>1,
    'notes'=>'1 rapport de cas d\'augmentation de l\'INR (=7) avec hématurie et saignements gingivaux chez une femme de 76 ans stabilisée sous warfarine (INR normal à 2) consommant depuis peu du gingembre',
    'user_id'=>3,
    'validated'=>1
    ] );
    ...
    Target::create( [
        ...
        Target::create( [
        'id'=>118,
        'name'=>'Etude clinique (Ginkgo + haloperidol)',
        'long_name'=>'Etude en double aveugle contrôlée par placebo sur 109 patients schizophrènes (Ginkgo + haloperidol)',
        'target_type_id'=>4,
        'notes'=>'Etude en double aveugle contre placebo sur 109 patients schizophrènes. Amélioration des symptômes schizophréniques chez les patients recevant de l\'halopéridol et du ginkgo',
        'user_id'=>3,
        'validated'=>1
        ] );
        ...
        Target::create( [
        'id'=>122,
        'name'=>'Etude clinique (Gingko + ticlopidine)',
        'long_name'=>'Etude randomisée sur sujets sains (Gingko + ticlopidine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>123,
        'name'=>'Case report de coma (Gingko + trazodone)',
        'long_name'=>'1 rapport de cas de coma (Gingko + trazodone)',
        'target_type_id'=>1,
        'notes'=>'1 rapport de cas de coma chez une patiente atteinte de la maladie d\'Alzheimer consommant des extraits de ginkgo : possible augmentation de l\'effet de la trazodone par le ginkgo',
        'user_id'=>3,
        'validated'=>1
        ] );
        ...
        Target::create( [
        'id'=>125,
        'name'=>'Case report  (Ginseng + warfarine)',
        'long_name'=>'Cas de diminution de l\'INR (Ginseng + warfarine)',
        'target_type_id'=>1,
        ...
        'long_name'=>'Etude sur 12 patients (Millepertuis + amitriptyline)',
        'target_type_id'=>4,
        ...
        'id'=>129,
        'name'=>'Etude clinique (Millepertuis + ciclosporine)',
        'long_name'=>'Etude sur 21 sujets sains (Millepertuis + ciclosporine)',
        'target_type_id'=>4,
        ...
        'id'=>130,
        'name'=>'Etude clinique (millepertuis + ciclosporine)',
        'long_name'=>'Etude en crossover sur 10 transplantés (millepertuis + ciclosporine)',
        'target_type_id'=>4,
        ...
        'id'=>133,
        'name'=>'Etude clinique (Millepertuis + digoxine)',
        'long_name'=>'L\'administration d\'un extrait de millepertuis à 8 volontaires sains (Millepertuis + digoxine)',
        'target_type_id'=>4,
        ...
        'id'=>134,
        'name'=>'Etude clinique (Millepertuis + fexofenadine)',
        'long_name'=>'Etude sur 12 volontaires sains (Millepertuis + fexofenadine)',
        'target_type_id'=>4,
        ...
        'id'=>135,
        'name'=>'Etude clinique  (Millepertuis + fexofenadine)',
        'long_name'=>'Etude sur 21 sujets sains (Millepertuis + fexofenadine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>136,
        'name'=>'Etude clinique (Millepertuis + gliclazide)',
        'long_name'=>'Etude sur 21 volontaires sains (Millepertuis + gliclazide)',
        'target_type_id'=>4,
        'notes'=>'Etude sur 21 volontaires sains recevant soit du gliclazide seul soit du gliclazide et du millepertuis (300mg 3 fois par jour) pendant 15 jours. Diminution de l\'AUC, de la 1/2 vie d\'élimination et de la clairance du gliclazide. L\'importance de l\'effet n\'est pas influencée par le génotype du CYP 2C9',
        'user_id'=>3,
        'validated'=>1
        ] );
        ...
        Target::create( [
        'id'=>139,
        'name'=>'Etude clinique   (Millepertuis + méthadone)',
        'long_name'=>'Etude sur 4 patients sous méthadone (Millepertuis + méthadone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>140,
        'name'=>'Etude clinique (Millepertuis + rosiglitazone)',
        'long_name'=>'Etude pharmacocinétique sur 27 sujets sains (Millepertuis + rosiglitazone)',
        'target_type_id'=>4,
        ...
        'long_name'=>'1 rapport de cas d\'épisode maniaque (Millepertuis + sertraline)',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>142,
        'name'=>'Case report  (Millepertuis + tacrolimus)',
        'long_name'=>'Cas de diminution des concentrations plasmatiques de tacrolimus (Millepertuis + tacrolimus)',
        'target_type_id'=>1,
        ...
        'long_name'=>'Cas avec syndrome sérotoninergique (Millepertuis + venlafaxine)',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>148,
        'name'=>'Case report  (Soja extrait + levothyroxine)',
        'long_name'=>'Cas décrivant une femme (Soja extrait + levothyroxine)',
        'target_type_id'=>1,
        'notes'=>'1 rapport de cas décrivant une femme ayant besoin de doses anormalement haute de levothyroxine suite à la consommation quotidienne d\'extraits de soja. Doses nécessaires revenues à la normale après séparation des prises dans le temps',
        'user_id'=>3,
        'validated'=>1
        ] );
        ...
        Target::create( [
        'id'=>152,
        'name'=>'Etude clinique (Soja natto + warfarine)',
        'long_name'=>'Etude rétrospective sur 10 patients (Soja natto + warfarine)',
        'target_type_id'=>4,
        ...
        Target::create( [
            ...
            'long_name'=>'Cas de diminution d\'INR (Thé vert + warfarine)',
            'target_type_id'=>1,
            'notes'=>'Un case report de diminution d\'INR chez un patient sous warfarine consommant de grandes quantités de thé vert (entre 2 et 4L par jour)',
            'user_id'=>3,
            'validated'=>1
            ] );
            ...
            Target::create( [
                ...
                Target::create( [
                    'id'=>155,
                    'name'=>'Etudes clinique (Thé noir + fer)',
                    'long_name'=>'Etudes (16) sur la consommation de thé (Thé noir + fer)',
                    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>157,
    'name'=>'Cas report (Thé noir + fer)',
    'long_name'=>'Cas de mauvaise réponse (Thé noir + fer)',
    'target_type_id'=>1,
...
Target::create( [
    'id'=>158,
    'name'=>'Dopaminergique',
    'long_name'=>'les plantes agissant comme agoniste ou antagoniste dopaminergique peuvent intéragir avec les médicaments ayant la meme cible',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>2,
    'validated'=>1
    ...
    Target::create( [
    'id'=>186,
    'name'=>'Case report (Ginkgo + warfarine)',
    'long_name'=>'Case report (Ginkgo + warfarine)',
    'target_type_id'=>1,
    ...
    Target::create( [
        ...
        Target::create( [
        'id'=>190,
        'name'=>'Case report (Ginseng asiatique + phénelzine)',
        'long_name'=>'',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>192,
        'name'=>'Case report (Harpagophytum + warfarine)',
        'long_name'=>'Case report (Harpagophytum + warfarine)',
        'target_type_id'=>1,
        ...
        Target::create( [
            'id'=>201,
            'name'=>'Case report (Millepertuis + docétaxel)',
            'long_name'=>'Case report (Millepertuis + docétaxel)',
            'target_type_id'=>1,
            ...
            'id'=>210,
            'name'=>'Etude clinique (Millepertuis + méthadone)',
            'long_name'=>'Etude sur 4 patients (Millepertuis + méthadone)',
            'target_type_id'=>4,
            'notes'=>'Etude sur 4 patients. Diminution des concentrations plasmatiques de méthadone avec risque d\'apparition de symptômes de manque.',
            'user_id'=>3,
            'validated'=>1
            ] );
            ...
            Target::create( [
            'id'=>250,
            'name'=>'Case report (Réglisse + paclitaxel)',
            'long_name'=>'Case report (Réglisse + paclitaxel)',
            'target_type_id'=>1,
            ...
            Target::create( [
            'id'=>251,
            'name'=>'Case report (Réglisse + vinblastine)',
            'long_name'=>'Case report (Réglisse + vinblastine)',
            'target_type_id'=>1,
            'notes'=>'In vitro, potentialisation de l\'activité cytotoxique.',
            'user_id'=>3,
            'validated'=>1
            ...
            Target::create( [
                ...
                Target::create( [
                'id'=>272,
                'name'=>'Etude clinique (Pamplemousse + triazolam)',
                'long_name'=>'Etude clinique (Pamplemousse + triazolam)',
                'target_type_id'=>4,
                'notes'=>'Etude randomisée en cross over sur 10 sujets sains recevant une dose unique de triazolam (0,25mg) avec du jus de pamplemousse ou de l\'eau. Augmentation de l\'aire sous la courbe et de la Cmax du triazolam entrainant une somnolence accrue. Inhibition du CYP 3A4',
                'user_id'=>3,
                'validated'=>1
                ] );
                ...
                Target::create( [
                'id'=>274,
                'name'=>'Case report (Menthe poivrée HE + félodipine)',
                'long_name'=>'Case report (Menthe poivrée HE + félodipine)',
                'target_type_id'=>1,
                'notes'=>'Augmentation de l\'exposition (AUC) à la félodipine chez le volontaire sain par inhibition des CYP 3A4 intestinaux',
                'user_id'=>3,
                'validated'=>1
                ] );
                ...
                Target::create( [
                'id'=>275,
                'name'=>'Case report (Pomélo + albendazole)',
                'long_name'=>'Case report (Pomélo + albendazole)',
                'target_type_id'=>1,
                'notes'=>'Pas d\'augmentation de l\'exposition (AUC) à la félodipine chez le volontaire sain par inhibition des CYP 3A4 intestinaux',
                'user_id'=>3,
                'validated'=>1
                ] );
                ...
                Target::create( [
                'id'=>276,
                'name'=>'Case report (Pomélo + amlodipine)',
                'long_name'=>'Case report (Pomélo + amlodipine)',
                'target_type_id'=>1,
                ...
                Target::create( [
                    'id'=>277,
                    'name'=>'Case report (Pomélo + arthéméther)',
                    'long_name'=>'Case report (Pomélo + arthéméther)',
                    'target_type_id'=>1,
                    ...
                    Target::create( [
                    'id'=>278,
                    'name'=>'Case report (Pomélo + atorvastatine)',
                    'long_name'=>'Case report (Pomélo + atorvastatine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain ',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>279,
                    'name'=>'Case report (Pomélo + caféine)',
                    'long_name'=>'Case report (Pomélo + caféine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>280,
                    'name'=>'Case report (Pomélo + carbamazépine)',
                    'long_name'=>'Case report (Pomélo + carbamazépine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>282,
                    'name'=>'Case report (Pomélo + cisapride)',
                    'long_name'=>'Case report (Pomélo + cisapride)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>283,
                    'name'=>'Case report (Pomélo + dextromethorphan)',
                    'long_name'=>'Case report (Pomélo + dextromethorphan)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>284,
                    'name'=>'Case report (Pomélo + diltiazem)',
                    'long_name'=>'Case report (Pomélo + diltiazem)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>285,
                    'name'=>'Case report (Pomélo + érythromycine)',
                    'long_name'=>'Case report (Pomélo + érythromycine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>286,
                    'name'=>'Case report (Pomélo + éthinylestradiol)',
                    'long_name'=>'Case report (Pomélo + éthinylestradiol)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>287,
                    'name'=>'Case report (Pomélo + fluvoxamine)',
                    'long_name'=>'Case report (Pomélo + fluvoxamine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>288,
                    'name'=>'Case report (Pomélo + hyoscine)',
                    'long_name'=>'Case report (Pomélo + hyoscine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>290,
                    'name'=>'Case report (Pomélo + lansoprazole)',
                    'long_name'=>'Case report (Pomélo + lansoprazole)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>291,
                    'name'=>'Case report (Pomélo + losartan)',
                    'long_name'=>'Case report (Pomélo + losartan)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>292,
                    'name'=>'Case report (Pomélo + lovastatine)',
                    'long_name'=>'Case report (Pomélo + lovastatine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>293,
                    'name'=>'Case report (Pomélo + méthadone)',
                    'long_name'=>'Case report (Pomélo + méthadone)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>294,
                    'name'=>'Case report (Pomélo + méthylprednisolone)',
                    'long_name'=>'Case report (Pomélo + méthylprednisolone)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>295,
                    'name'=>'Case report (Pomélo + nifédipine)',
                    'long_name'=>'Case report (Pomélo + nifédipine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>296,
                    'name'=>'Case report (Pomélo + nilotinib)',
                    'long_name'=>'Case report (Pomélo + nilotinib)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>297,
                    'name'=>'Case report (Pomélo + nimodipine)',
                    'long_name'=>'Case report (Pomélo + nimodipine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>298,
                    'name'=>'Case report (Pomélo + pivastatine)',
                    'long_name'=>'Case report (Pomélo + pivastatine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>299,
                    'name'=>'Case report (Pomélo + praziquantel)',
                    'long_name'=>'Case report (Pomélo + praziquantel)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>300,
                    'name'=>'Case report (Pomélo + primaquine)',
                    'long_name'=>'Case report (Pomélo + primaquine)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>301,
                    'name'=>'Case report (Pomélo + quazepam)',
                    'long_name'=>'Case report (Pomélo + quazepam)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>302,
                    'name'=>'Case report (Pomélo + répaglinide)',
                    'long_name'=>'Case report (Pomélo + répaglinide)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>303,
                    'name'=>'Case report (Pomélo + saquinavir)',
                    'long_name'=>'Case report (Pomélo + saquinavir)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>304,
                    'name'=>'Case report (Pomélo + sertaline)',
                    'long_name'=>'Case report (Pomélo + sertaline)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>305,
                    'name'=>'Case report (Pomélo + sildénafil)',
                    'long_name'=>'Case report (Pomélo + sildénafil)',
                    'target_type_id'=>1,
                    'notes'=>'Pas d\'augmentation de l\'exposition au médicament par inhibition des CYP 3A4 intestinaux par le jus de pomélo chez le volontaire sain',
                    'user_id'=>3,
                    'validated'=>1
                ...
                Target::create( [
                'id'=>306,
                'name'=>'Case report (Pomélo + amiodarone)',
                'long_name'=>'Case report (Pomélo + amiodarone)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>307,
                'name'=>'Case report (Pomélo + buspirone)',
                'long_name'=>'Case report (Pomélo + buspirone)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>308,
                'name'=>'Case report (Pomélo + clomipramine)',
                'long_name'=>'Case report (Pomélo + clomipramine)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>309,
                'name'=>'Case report (Pomélo + colchicine)',
                'long_name'=>'Case report (Pomélo + colchicine)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>310,
                'name'=>'Case report (Pomélo + félodipine)',
                'long_name'=>'Case report (Pomélo + félodipine)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>311,
                'name'=>'Case report (Pomélo + midazolam)',
                'long_name'=>'Case report (Pomélo + midazolam)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>312,
                'name'=>'Case report (Pomélo + nisoldipine)',
                'long_name'=>'Case report (Pomélo + nisoldipine)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>313,
                'name'=>'Case report (Pomélo + oxycodone)',
                'long_name'=>'Case report (Pomélo + oxycodone)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>314,
                'name'=>'Case report (Pomélo + simvastatine)',
                'long_name'=>'Case report (Pomélo + simvastatine)',
                'target_type_id'=>1,
                ...
                Target::create( [
                'id'=>315,
                'name'=>'Case report (Pomélo + triazolam)',
                'long_name'=>'Case report (Pomélo + triazolam)',
                'target_type_id'=>1,
                'notes'=>'Effets psychomoteurs négatifs',
                'user_id'=>3,
                'validated'=>1
                ...
                Target::create( [
                'id'=>316,
                'name'=>'Case report (Pomélo + vérapamil)',
                'long_name'=>'Case report (Pomélo + vérapamil)',
                'target_type_id'=>1,
                ...
                Target::create( [
                    'id'=>317,
                    'name'=>'Case report (Pomélo + aliskiren)',
                    'long_name'=>'Case report (Pomélo + aliskiren)',
                    'target_type_id'=>1,
                    ...
                    Target::create( [
                    'id'=>318,
                    'name'=>'Case report (Pomélo + céliprolol)',
                    'long_name'=>'Case report (Pomélo + céliprolol)',
                    'target_type_id'=>1,
                    'notes'=>'Diminution de l\'exposition au médicament due à une inhibition des transporteurs OATP',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>319,
                    'name'=>'Case report (Pomélo + fexofénadine)',
                    'long_name'=>'Case report (Pomélo + fexofénadine)',
                    'target_type_id'=>1,
                    'notes'=>'Diminution de l\'exposition au médicament due à une inhibition des transporteurs OATP',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>320,
                    'name'=>'Case report (Pomélo + glibenclamide)',
                    'long_name'=>'Case report (Pomélo + glibenclamide)',
                    'target_type_id'=>1,
                    'notes'=>'Diminution de l\'exposition au médicament due à une inhibition des transporteurs OATP',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>321,
                    'name'=>'Case report (Pomélo + talinolol)',
                    'long_name'=>'Case report (Pomélo + talinolol)',
                    'target_type_id'=>1,
                    'notes'=>'Diminution de l\'exposition au médicament due à une inhibition des transporteurs OATP',
                    'user_id'=>3,
                    'validated'=>1
                    ...
                    Target::create( [
                    'id'=>328,
                    'name'=>'Etude clinique (Ail  caféine)',
                    'long_name'=>'Etude clinique (Ail  caféine)',
                    'target_type_id'=>4,
                    ...
                    Target::create( [
                    'id'=>332,
                    'name'=>'Etude clinique (Ail + debrisoquinone)',
                    'long_name'=>'Etude clinique (Ail + debrisoquinone)',
                    'target_type_id'=>4,
                    ...
                    Target::create( [
                        'id'=>334,
                        'name'=>'Etude clinique (Ail + dextromethophane)',
                        'long_name'=>'Etude clinique (Ail + dextromethophane)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>341,
                        'name'=>'Etude clinique (Echinacée + chlorzoxazone)',
                        'long_name'=>'Etude clinique (Echinacée + chlorzoxazone)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>343,
                        'name'=>'Etude clinique (Echinacée + dextromethorphan)',
                        'long_name'=>'Etude clinique (Echinacée + dextromethorphan)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>344,
                        'name'=>'Etude clinique (Echinacée + tolbutamide)',
                        'long_name'=>'Etude clinique (Echinacée + tolbutamide)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>345,
                        'name'=>'Etude clinique (Palmier de floride + alprazolam)',
                        'long_name'=>'Etude clinique (Palmier de floride + alprazolam)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>346,
                        'name'=>'Etude clinique (Echinacées + warfarine)',
                        'long_name'=>'Etude clinique (Echinacées + warfarine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>347,
                        'name'=>'Etude clinique (Palmier de floride + caféine)',
                        'long_name'=>'Etude clinique (Palmier de floride + caféine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>348,
                        'name'=>'Etude clinique (Palmier de floride + Chlorzoxazone)',
                        'long_name'=>'Etude clinique (Palmier de floride + Chlorzoxazone)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>349,
                        'name'=>'Etude clinique (Palmier de floride + debrisoquine)',
                        'long_name'=>'Etude clinique (Palmier de floride + debrisoquine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>350,
                        'name'=>'Etude clinique (Palmier de floride + dextromethorphane)',
                        'long_name'=>'Etude clinique (Palmier de floride + dextromethorphane)',
                        'target_type_id'=>4,
                        'notes'=>' Etude clinique sur 12 sujets recevant 320mg de palmier (capsule contenant 197,7mg d\'acides gras non estérifiés, représentant 62% de l\'extrait total). Aucun effet sur la pharmacocinétique du dextromethorphane. Aucun effet sur CYP2D6. ',
                        'user_id'=>3,
                        'validated'=>1
                        ] );
                        ...
                        Target::create( [
                        'id'=>351,
                        'name'=>'Etude clinique (Palmier de floride + midazolam)',
                        'long_name'=>'Etude clinique (Palmier de floride + midazolam)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>352,
                        'name'=>'Etude clinique (Ginkgo + alprazolam)',
                        'long_name'=>'Etude clinique (Ginkgo + alprazolam)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>353,
                        'name'=>'Etude clinique (Ginkgo + bupropion)',
                        'long_name'=>'Etude clinique (Ginkgo + bupropion)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>356,
                        'name'=>'Etude clinique (Ginkgo + débrisoquine)',
                        'long_name'=>'Etude clinique (Ginkgo + débrisoquine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>358,
                        'name'=>'Etude clinique (Ginkgo + diazepam)',
                        'long_name'=>'Etude clinique (Ginkgo + diazepam)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>359,
                        'name'=>'Etude clinique (Ginkgo + flurbiprofène)',
                        'long_name'=>'Etude clinique (Ginkgo + flurbiprofène)',
                        'target_type_id'=>4,
                        'notes'=>'Etude clinique randomisée en cross over sur 11 sujets recevant 2x60mg de ginkgo biloba (Comprimé EGb761) 3 fois/jour durant 1jour. Aucun effet sur la pharmacocinétique du flurbiprofène. Aucun effet sur CYP2C9.',
                        'user_id'=>3,
                        'validated'=>1
                        ] );
                        ...
                        Target::create( [
                        'id'=>360,
                        'name'=>'Etude clinique (Echinacée + lopinavir)',
                        'long_name'=>'Etude clinique (Echinacée + lopinavir)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>361,
                        'name'=>'Etude clinique (Echinacée + ritonavir)',
                        'long_name'=>'Etude clinique (Echinacée + ritonavir)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>362,
                        'name'=>'Etude clinique (Gingko + cortisol)',
                        'long_name'=>'Etude clinique (Gingko + cortisol)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>363,
                        'name'=>'Etude clinique (Ginkgo + ritonavir)',
                        'long_name'=>'Etude clinique (Ginkgo + ritonavir)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>366,
                        'name'=>'Etude clinique (Ginkgo + warfarine)',
                        'long_name'=>'Etude clinique (Ginkgo + warfarine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>367,
                        'name'=>'Etude clinique (Canneberge + ciclosporine)',
                        'long_name'=>'Etude clinique (Canneberge + ciclosporine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>368,
                        'name'=>'Etude clinique (Canneberge + diclofenac)',
                        'long_name'=>'Etude clinique (Canneberge + diclofenac)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>369,
                        'name'=>'Etude clinique (Canneberge + flurbiprofen)',
                        'long_name'=>'Etude clinique (Canneberge + flurbiprofen)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>370,
                        'name'=>'Etude clinique (Canneberge + midazolam)',
                        'long_name'=>'Etude clinique (Canneberge + midazolam)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>371,
                        'name'=>'Etude clinique (Cannebeerge + tizanidine)',
                        'long_name'=>'Etude clinique (Cannebeerge + tizanidine)',
                        'target_type_id'=>4,
                        'notes'=>'Etude clinique randomisée en crossover sur 10 sujets recevant 200ml de canneberge (jus concentré dilué à l\'eau 1:4 vol/vol) 3 fois/jour durant 10 jours. Aucun effet sur la pharmacocinétique de la tizanidine. Aucun effet sur CYP1A2. ',
                        'user_id'=>3,
                        'validated'=>1
                        ] );
                        ...
                        Target::create( [
                        'id'=>373,
                        'name'=>'Etude clinique (Gingko + tolbutamide )',
                        'long_name'=>'Etude clinique (Gingko + tolbutamide 2)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>376,
                        'name'=>'Etude clinique (Soja + caféine)',
                        'long_name'=>'Etude clinique (Soja + caféine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>377,
                        'name'=>'Etude clinique (Soja + cortisol)',
                        'long_name'=>'Etude clinique (Soja + cortisol)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>378,
                        'name'=>'Etude clinique (Soja + losartan)',
                        'long_name'=>'Etude clinique (Soja + losartan)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>380,
                        'name'=>'Etude clinique (Ginseng + caféine)',
                        'long_name'=>'Etude clinique (Ginseng + caféine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>381,
                        'name'=>'Etude clinique (Ginseng + chlorzoxazone)',
                        'long_name'=>'Etude clinique (Ginseng + chlorzoxazone)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>382,
                        'name'=>'Etude clinique (Ginseng + cortisol)',
                        'long_name'=>'Etude clinique (Ginseng + cortisol)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>383,
                        'name'=>'Etude clinique (ginseng + debrisoquine)',
                        'long_name'=>'Etude clinique (ginseng + debrisoquine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>384,
                        'name'=>'Etude clinique (Ginseng + midazolam)',
                        'long_name'=>'Etude clinique (Ginseng + midazolam)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>385,
                        'name'=>'Etude clinique (Ginseng + warfarine)',
                        'long_name'=>'Etude clinique (Ginseng + warfarine 2)',
                        'target_type_id'=>4,
                        ...
                        'id'=>386,
                        'name'=>'Etude clinique (ginseng + warfarine)',
                        'long_name'=>'Etude clinique (ginseng + rac-warfarine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>387,
                        'name'=>'Etude clinique (actée à grappes + caféine)',
                        'long_name'=>'Etude clinique (actée à grappes + caféine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>388,
                        'name'=>'Etude clinique (Actée à grappes + chlozoxazone)',
                        'long_name'=>'Etude clinique (Actée à grappes + chlozoxazone)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>389,
                        'name'=>'Etude clinique (Actée à grappes + débrisoquine)',
                        'long_name'=>'Etude clinique (Actée à grappes + débrisoquine)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                        'id'=>391,
                        'name'=>'Etude clinique (Actée à grappes + midazolam)',
                        'long_name'=>'Etude clinique (Actée à grappes + midazolam)',
                        'target_type_id'=>4,
                        ...
                        Target::create( [
                            ...
                            'long_name'=>'Etude clinique (Millepertuis + alprazolam)',
                            'target_type_id'=>4,
                            'notes'=>'Deux études randomisées contre placebo ont été réalisées avec 28 volontaires sains (18 - 55 ans). Dans l\'étude A, des doses uniques de l\'alprazolam (1 mg ; substrat du CYP3A4) et la caféine (100 mg ; CYP1A2) ont été administrées aux jours 1 et 11. Dans l\'étude B, des doses uniques de tolbutamide (500 mg, jours 1 et 11 ; CYP2C9) et de doses multiples allant de  digoxine ( 0,75 mg aux jours -2 et -1, 0,25 mg / les jours 1 à 11 ) étaient donné. Les participants ont reçudu  millepertuis ( Esbericum® ; 240 mg / d\'extrait  soit 3,5 mg d\'hyperforine ) ou un placebo aux jours 2 à 11 . Une analyse dans le sang a été établie aux jours 1 et 11. Aucune différence statistiquement significative n\'a été observée dans le paramètre cinétique primaire, AUC0 - 24 d\'alprazolam, de la caféine (AUC0 - 12) , la paraxanthine , le tolbutamide , le 4- hydroxytolbutamide , et la digoxine entre le groupe placebo et le groupe millepertuis . La variation induite dans le MP - ASC était inférieur à 12% de l\'AUC médiane initiale des participants à des études A et B, donc cliniquement non pertinent. Le jour 11, les concentrations minimales étaient de 2,0 (intervalle de 0,6 à 4,1) microg / L et 1,0 (0,2 à 3,9 ) microg / L pour l\'hypéricine et pseudohypericine, respectivement , tandis que les concentrations hyperforine étaient inférieurs à la limite de quantification ( < 1 microg / L). ',
                            'user_id'=>3,
                            'validated'=>1
                            ] );
...
Target::create( [
    'id'=>468,
    'name'=>'Etude clinique (Millepertuis + bupropion)',
    'long_name'=>'Etude clinique (Millepertuis + bupropion)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>394,
    'name'=>'Etude clinique (Millepertuis + caféine)',
    'long_name'=>'Etude clinique (Millepertuis + caféine)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>395,
    'name'=>'Etude clinique (Millepertuis + chlorzoxazone)',
    'long_name'=>'Etude clinique (Millepertuis + chlorzoxazone)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>396,
    'name'=>'Etude clinique (Millepertuis + cortisol)',
    'long_name'=>'Etude clinique (Millepertuis + cortisol)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>398,
    'name'=>'Etude clinique (Millepertuis + débrisoquine)',
    'long_name'=>'Etude clinique (Millepertuis + débrisoquine)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>399,
    'name'=>'Etude clinique (Millepertuis + désogestrel)',
    'long_name'=>'Etude clinique (Millepertuis + désogestrel)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>400,
    'name'=>'Etude clinique (Millepertuis + dextromethorphane)',
    'long_name'=>'Etude clinique (Millepertuis + dextromethorphane)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>401,
    'name'=>'Etude clinique (Millepertuis + ethinylestradiol + midazolam)',
    'long_name'=>'Etude clinique (Millepertuis + ethinylestradiol + midazolam)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>402,
    'name'=>'Etude clinique (Millepertuis + éthinylestradiol)',
    'long_name'=>'Etude clinique (Millepertuis + éthinylestradiol)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>404,
    'name'=>'Etude clinique (Millepertuis + ivabradine)',
    'long_name'=>'Etude clinique (Millepertuis + ivabradine)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>406,
    'name'=>'Etude clinique (Millepertuis + méphénytoïne)',
    'long_name'=>'Etude clinique (Millepertuis + méphénytoïne)',
    'target_type_id'=>4,
    ...
    'id'=>408,
    'name'=>'Etude clinique (Millepertuis + midazolam)',
    'long_name'=>'Etude clinique (Millepertuis + midazolam2)',
    'target_type_id'=>4,
    ...
    Target::create( [
        'id'=>410,
        'name'=>'Etude clinique (Millepertuis + midazolam)',
        'long_name'=>'Etude clinique (Millepertuis + midazolam4)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>411,
        'name'=>'Etude clinique (Millepertuis + norethindrone)',
        'long_name'=>'Etude clinique (Millepertuis + norethindrone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>412,
        'name'=>'Etude clinique (Millepertuis + quazepam)',
        'long_name'=>'Etude clinique (Millepertuis + quazepam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>413,
        'name'=>'Etude clinique (Millepertuis + tolbutamide)',
        'long_name'=>'Etude clinique (Millepertuis + tolbutamide)',
        'target_type_id'=>4,
        ...
        'id'=>414,
        'name'=>'Etude clinique (Millepertuis + warfarine)',
        'long_name'=>'Etude clinique (Millepertuis + Rac-warfarine)',
        'target_type_id'=>4,
        'notes'=>'Etude clinique randomisée en crossover sur 12 sujets recevant 1000mg 3 fois/j pdt 14 jours de millepertuis (Comprimé de l\'extrait sec correspondant à 1g d\'hypericum perforatum, 0.825mg d\'hypericine, 12.5mg d\'hyperforine). Réduction de 27% (p<0.05) de l\'AUC de la S-warfarine, réduction de 23% (p<0.05) de l\'AUC de la R-warfarine modifiant de manière notable la clearance de la S- et R- warfarine  respectivement de 29% (p<0.05) et 23% (p<0.05). Induction du CYP1A2 et/ou CYP3A4 et CYP2C9.',
        'user_id'=>3,
        'validated'=>1
        ] );
        ...
        Target::create( [
        'id'=>415,
        'name'=>'Etude clinique (Chardon-marie + caféine)',
        'long_name'=>'Etude clinique (Chardon-marie + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>416,
        'name'=>'Etude clinique (Chardon-marie + chlorzoxazone)',
        'long_name'=>'Etude clinique (Chardon-marie + chlorzoxazone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>417,
        'name'=>'Etude clinique (Chardon-marie + débrisoquine)',
        'long_name'=>'Etude clinique (Chardon-marie + débrisoquine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>418,
        'name'=>'Etude clinique (Chardon-marie + midazolam)',
        'long_name'=>'Etude clinique (Chardon-marie + midazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>419,
        'name'=>'Etude clinique (Chardon-marie + nifédipine)',
        'long_name'=>'Etude clinique (Chardon-marie + nifédipine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>420,
        'name'=>'Etude clinique (Thé vert + alprazolam)',
        'long_name'=>'Etude clinique (Thé vert + alprazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>421,
        'name'=>'Etude clinique (thé vert + buspirone)',
        'long_name'=>'Etude clinique (thé vert + buspirone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>422,
        'name'=>'Etude clinique (thé vert + caféine)',
        'long_name'=>'Etude clinique (thé vert + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>423,
        'name'=>'Etude clinique (Thé vert + dextromethorphane)',
        'long_name'=>'Etude clinique (Thé vert + dextromethorphane)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>424,
        'name'=>'Etude clinique (Thé vert + losartan)',
        'long_name'=>'Etude clinique (Thé vert + losartan)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>425,
        'name'=>'Etude clinique (Valériane + alprazolam)',
        'long_name'=>'Etude clinique (Valériane + alprazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>426,
        'name'=>'Etude clinique (Valériane + caféine)',
        'long_name'=>'Etude clinique (Valériane + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>427,
        'name'=>'Etude clinique (Valériane + chlorzoxazone)',
        'long_name'=>'Etude clinique (Valériane + chlorzoxazone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>428,
        'name'=>'Etude clinique (Valériane +débrisoquine)',
        'long_name'=>'Etude clinique (Valériane +débrisoquine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>429,
        'name'=>'Etude clinique (Valériane + dextrométhophane)',
        'long_name'=>'Etude clinique (Valériane + dextrométhophane)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>430,
        'name'=>'Etude clinique (Valériane + midazolam)',
        'long_name'=>'Etude clinique (Valériane + midazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>431,
        'name'=>'Etude clinique (Kava + caféine)',
        'long_name'=>'Etude clinique (Kava + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>432,
        'name'=>'Etude clinique (Kava + chlorzoxazone)',
        'long_name'=>'Etude clinique (Kava + chlorzoxazone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>433,
        'name'=>'Etude clinique (Kava + débrisoquine)',
        'long_name'=>'Etude clinique (Kava + débrisoquine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>434,
        'name'=>'Etude clinique (Kava + midazolam)',
        'long_name'=>'Etude clinique (Kava + midazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>435,
        'name'=>'Etude clinique (Gingembre + warfarine)',
        'long_name'=>'Etude clinique (Gingembre + rac-warfarine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>436,
        'name'=>'Etude clinique (Echinacées + midazolam)',
        'long_name'=>'Etude clinique (Echinacées + midazolam1)',
        'target_type_id'=>4,
        ...
        'id'=>437,
        'name'=>'Etude clinique (Echinacées + midazolam)',
        'long_name'=>'Etude clinique (Echinacées + midazolam2)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>438,
        'name'=>'Etude clinique (Hydrastis + caféine)',
        'long_name'=>'Etude clinique (Hydrastis + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>439,
        'name'=>'Etude clinique (Hydrastis + chlozoxazone)',
        'long_name'=>'Etude clinique (Hydrastis + chlozoxazone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>440,
        'name'=>'Etude clinique (Hydrastis + débrisoquine)',
        'long_name'=>'Etude clinique (Hydrastis + débrisoquine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>441,
        'name'=>'Etude clinique (Hydrastis + midazolam)',
        'long_name'=>'Etude clinique (Hydrastis + midazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>443,
        'name'=>'Etude clinique (Angélique koréenne + caféine)',
        'long_name'=>'Etude clinique (Angélique koréenne + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>444,
        'name'=>'Etude clinique (Angélique koréenne +chloroxazone)',
        'long_name'=>'Etude clinique (Angélique koréenne +chloroxazone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>445,
        'name'=>'Etude clinique (Angélique koréenne +  dextrométhorphane)',
        'long_name'=>'Etude clinique (Angélique koréenne +  dextrométhorphane)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>446,
        'name'=>'Etude clinique (Angélique koréenne + losartan)',
        'long_name'=>'Etude clinique (Angélique koréenne + losartan)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>447,
        'name'=>'Etude clinique (Angélique koréenne + midazolam)',
        'long_name'=>'Etude clinique (Angélique koréenne + midazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>448,
        'name'=>'Etude clinique (Angélique koréenne + oméprazole)',
        'long_name'=>'Etude clinique (Angélique koréenne + oméprazole)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>449,
        'name'=>'Etude clinique (Vigne + buspirone)',
        'long_name'=>'Etude clinique (Vigne + buspirone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>450,
        'name'=>'Etude clinique (Vigne + caféine)',
        'long_name'=>'Etude clinique (Vigne + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>451,
        'name'=>'Etude clinique (Vigne + dextromethorphane)',
        'long_name'=>'Etude clinique (Vigne + dextromethorphane)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>452,
        'name'=>'Etude clinique (Curcuma + caféine)',
        'long_name'=>'Etude clinique (Curcuma + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>453,
        'name'=>'Etude clinique (Scutellaire + bupropion)',
        'long_name'=>'Etude clinique (Scutellaire + bupropion)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>454,
        'name'=>'Etude clinique (Scutellaire + caféine)',
        'long_name'=>'Etude clinique (Scutellaire + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>455,
        'name'=>'Etude clinique (Scutellaire + dextromethorphane)',
        'long_name'=>'Etude clinique (Scutellaire + dextromethorphane)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>456,
        'name'=>'Etude clinique (Scutellaire +midazolam)',
        'long_name'=>'Etude clinique (Scutellaire +midazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>457,
        'name'=>'Etude clinique (Scutellaire + omeprazole)',
        'long_name'=>'Etude clinique (Scutellaire + omeprazole)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>458,
        'name'=>'Etude clinique (Angélique chinoise + caféine)',
        'long_name'=>'Etude clinique (Angélique chinoise + caféine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>459,
        'name'=>'Etude clinique (Angélique chinoise + chlorzoxazone)',
        'long_name'=>'Etude clinique (Angélique chinoise + chlorzoxazone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>460,
        'name'=>'Etude clinique (Angélique chinoise + dextromethorphane)',
        'long_name'=>'Etude clinique (Angélique chinoise + dextromethorphane)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>461,
        'name'=>'Etude clinique (Angélique chinoise + losartan)',
        'long_name'=>'Etude clinique (Angélique chinoise + losartan)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>462,
        'name'=>'Etude clinique (Angélique chinoise + midazolam)',
        'long_name'=>'Etude clinique (Angélique chinoise + midazolam)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>463,
        'name'=>'Etude clinique (Angélique chinoise + oméprazole)',
        'long_name'=>'Etude clinique (Angélique chinoise + oméprazole)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>464,
        'name'=>'Etude clinique (Scutellaire + chlorzoxazone)',
        'long_name'=>'Etude clinique (Scutellaire + chlorzoxazone)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>465,
        'name'=>'Etude clinique (Scutellaire + losartan)',
        'long_name'=>'Etude clinique (Scutellaire + losartan)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>466,
        'name'=>'Etude clinique (Vigne + losartan)',
        'long_name'=>'Etude clinique (Vigne + losartan)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>469,
        'name'=>'Etude clinique (Millepertuis + carbamazépine)',
        'long_name'=>'Etude clinique (Millepertuis + carbamazépine)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>470,
        'name'=>'Etude clinique (Millepertuis + clopidrogrel)',
        'long_name'=>'Etude clinique (Millepertuis + clopidrogrel)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>471,
        'name'=>'Case report (Millepertuis + Clozapine)',
        'long_name'=>'Case report (Millepertuis + Clozapine)',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>472,
        'name'=>'Etude clinique (Millepertuis + finastéride)',
        'long_name'=>'Etude clinique (Millepertuis + finastéride)',
        'target_type_id'=>4,
...
Target::create( [
    'id'=>473,
    'name'=>'Etude clinique (Millepertuis + ibuprofène)',
    'long_name'=>'Etude clinique (Millepertuis + ibuprofène)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>474,
    'name'=>'Etude clinique (Millepertuis + acide mycophénolique)',
    'long_name'=>'Etude clinique (Millepertuis + acide mycophénolique)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>477,
    'name'=>'Case report (Millepertuis + rosuvastatine)',
    'long_name'=>'Case report (Millepertuis + rosuvastatine)',
    'target_type_id'=>1,
    ...
    Target::create( [
    'id'=>480,
    'name'=>'Etude clinique (Millepertuis + théophylline)',
    'long_name'=>'Etude clinique (Millepertuis + théophylline)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>482,
    'name'=>'Etude clinique (Millepertuis + zolpidem)',
    'long_name'=>'Etude clinique (Millepertuis + zolpidem)',
    'target_type_id'=>4,
    ...
    'id'=>486,
    'name'=>'Etude clinique (Caféine + Paracétamol)',
    'long_name'=>'Étude sur 10 volontaires sains de sexe masculin (Caféine + Paracétamol)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>488,
    'name'=>'Etude sur souris (Millepertuis + paracétamol)',
    'long_name'=>'Etude sur souris (Millepertuis + paracétamol)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>494,
    'name'=>'Etude clinique (Ginkgo biloba +Diclofénac)',
    'long_name'=>'Etude clinique (Ginkgo biloba +Diclofénac)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>498,
    'name'=>'Etude clinique (Caféine + diclofenac)',
    'long_name'=>'Etude sur des migraineux (Caféine + diclofenac)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>499,
    'name'=>'Case report (Ginkgo + ibuprofène)',
    'long_name'=>'Case report (Ginkgo + ibuprofène)',
    'target_type_id'=>1,
    ...
    Target::create( [
    'id'=>500,
    'name'=>'Case report (Ginkgo + Aspirine)',
    'long_name'=>'Case report (Ginkgo + Aspirine)',
    'target_type_id'=>1,
    'notes'=>'Majoration du risque de saignement.',
    'user_id'=>44,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>502,
    'name'=>'Case report (Harpagophytum + Paracétamol)',
    'long_name'=>'Case report (Harpagophytum + Paracétamol)',
    'target_type_id'=>1,
    'notes'=>'Une femme âgée de 81 ans a présenté des saignements digestifs, gastralgies, dyspepsies et une gastrite avec ulcère duodénal compliqué d\'un méléna. Cette femme prenait depuis plusieurs semaines des infusions de racine d\'harpogophyton, associées à du paracétamol pour des douleurs articulaires.',
    'user_id'=>44,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>504,
    'name'=>'Etude in vitro Anthraquinone + Kétoprofène',
    'long_name'=>'Etude in vitro Anthraquinone + Kétoprofène',
    'target_type_id'=>7,
    ...
    Target::create( [
    'id'=>523,
    'name'=>'Etude clinique (Curcuma/Pipérine + Paracétamol)',
    'long_name'=>'Etude clinique randomisée sur 8 volontaires sains (Curcuma/Pipérine + Paracétamol)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>511,
    'name'=>'Etude sur rat (Ginseng + Morphine)',
    'long_name'=>'Etude sur rat (Ginseng + Morphine)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>527,
    'name'=>'Etude in vitro Anthraquinone + Paracétamol',
    'long_name'=>'Etude in vitro Anthraquinone + Paracétamol',
    'target_type_id'=>7,
...
Target::create( [
    ...
    Target::create( [
    'id'=>520,
    'name'=>'Etude clinique (Jus de pomélo + Methylprednisolone)',
    'long_name'=>'Etude randomisée sur 10 sujets sains Etude clinique (Jus de pomélo + Methylprednisolone)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>546,
    'name'=>'Etude clinique (Millepertuis + metformine)',
    'long_name'=>'Etude clinique (Millepertuis + metformine)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>526,
    'name'=>'Etude sur lapin (Capsicum + théophylline)',
    'long_name'=>'Etude sur lapin (Capsicum + théophylline)',
    'target_type_id'=>6,
    'notes'=>'L\'utilisation régulière du piment de Cayenne peut augmenter l\'absorption de la théophylline.',
    'user_id'=>44,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>528,
    'name'=>'Etude in vitro Anthraquinone + Vérapamil',
    'long_name'=>'Etude in vitro Anthraquinone + Vérapamil',
    'target_type_id'=>7,
    ...
    Target::create( [
    'id'=>529,
    'name'=>'Etude in vitro Anthraquinone + Propranolol',
    'long_name'=>'Etude in vitro Anthraquinone + Propranolol',
    'target_type_id'=>7,
    ...
    Target::create( [
    'id'=>530,
    'name'=>'Etude in vitro Anthraquinone + Furosemide',
    'long_name'=>'Etude in vitro Anthraquinone + Furosemide',
    'target_type_id'=>7,
    'notes'=>'Les anthraquinones sont capables d\'interagir avec l\'épithélium intestinal et peuvent influer l\'absorption des médicaments lorsqu\'ils sont pris simultanément. Des monocouches de cellules épithéliales intestinales humaines sont évaluées comme modèle in vitro (modèle de culture cellulaire intestinal humain (Caco-2)). Une augmentation de la perméabilité intestinale du furosémide a été observée par la rhéine et le dantron (1,8-dihydroxyanthraquinone). Cette augmentation est peut être due à l\'ouverture de l\'espace extra-cellulaire compris entre deux cellules épithéliales adjacentes et/ou des effets des mécanismes d\'efflux.',
    'user_id'=>44,
    'validated'=>1
    ] );
    ...
    Target::create( [
    'id'=>545,
    'name'=>'Etude clinique (Ginkgo biloba + metformine)',
    'long_name'=>'Etude clinique (Ginkgo biloba + metformine)',
    'target_type_id'=>4,
    ...
    Target::create( [
    'id'=>532,
    'name'=>'Etude sur souris (Ginseng indien + Carbamazépine)',
    'long_name'=>'Etude sur souris (Ginseng indien + Carbamazépine)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>533,
    'name'=>'Etude sur souris (Ginseng indien + phénytoïne)',
    'long_name'=>'Etude sur souris (Ginseng indien + phénytoïne)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés.',
    'user_id'=>44,
    'validated'=>1
    ...
    Target::create( [
    'id'=>534,
    'name'=>'Etude sur souris (Ginseng indien + Phénobarbital)',
    'long_name'=>'Etude sur souris (Ginseng indien + phénobarbital)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés. ',
    'user_id'=>44,
    'validated'=>1
    ...
    Target::create( [
    'id'=>535,
    'name'=>'Etude sur souris (Ginseng indien + Acide valproïque)',
    'long_name'=>'Etude sur souris (Ginseng indien + Acide valproïque)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés. ',
    'user_id'=>44,
    'validated'=>1
    ...
    Target::create( [
    'id'=>536,
    'name'=>'Etude sur souris (Ginseng indien + Procaïnamide)',
    'long_name'=>'Etude sur souris (Ginseng indien + Procaïnamide)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés. ',
    'user_id'=>44,
    'validated'=>1
    ...
    Target::create( [
    'id'=>537,
    'name'=>'Etude sur souris (Ginseng indien + Théophylline)',
    'long_name'=>'Etude sur souris (Ginseng indien + Théophylline)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés. ',
    'user_id'=>44,
    'validated'=>1
    ...
    Target::create( [
    'id'=>538,
    'name'=>'Etude sur souris (Ginseng indien + gentamicine)',
    'long_name'=>'Etude sur souris (Ginseng indien + gentamicine)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés. ',
    'user_id'=>44,
    'validated'=>1
    ...
    Target::create( [
    'id'=>539,
    'name'=>'Etude sur souris (Ginseng indien + Tobramycine)',
    'long_name'=>'Etude sur souris (Ginseng indien + Tobramycine)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés. ',
    'user_id'=>44,
    'validated'=>1
    ...
    Target::create( [
    'id'=>540,
    'name'=>'Etude sur souris (Ginseng indien + Acide salicylique)',
    'long_name'=>'Etude sur souris (Ginseng indien + Acide salicylique)',
    'target_type_id'=>6,
    'notes'=>'Chaque souris (pesant environ 25 g) a reçu 20 µl d\'extrait de Ginseng indien. L\'extrait a été analysé pour 11 autres médicaments : carbamazépine, phénytoïne, phénobarbital, acide valproïque, procaïnamide, la N-acétyl procaïnamide, la théophylline, la gentamicine, la tobramycine, le paracétamol et l\'acide salicylique. Aucune diminution apparente des concentrations des médicaments étudiés. ',
    'user_id'=>44,
    'validated'=>1
    ...
    'id'=>549,
    'name'=>'OCT1',
    'long_name'=>'Organic Cation Transporter 1',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>30,
    'validated'=>1
    ...
    'id'=>550,
    'name'=>'OCT2',
    'long_name'=>'Organic Cation Transporter 2',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>30,
    'validated'=>1
    ...
    'id'=>551,
    'name'=>'MATE1',
    'long_name'=>'Multidrug And Toxin Extrusion 1',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>30,
    'validated'=>1
    ...
    'id'=>554,
    'name'=>'OAT3',
    'long_name'=>'Organic Anion Transporter 3',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>30,
    'validated'=>1
    ...
    'id'=>555,
    'name'=>'OAT1',
    'long_name'=>'Organic Anion Transporter 1',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>30,
    'validated'=>1
    ...
    'id'=>556,
    'name'=>'PEPT1/2',
    'long_name'=>'Peptide Transporter 1/2',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>30,
    'validated'=>1
    ...
    Target::create( [
    'id'=>557,
    'name'=>'Toxicité pancréatique',
    'long_name'=>'Toxicité pancréatique',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>30,
    'validated'=>1
    ...
    Target::create( [
    'id'=>563,
    'name'=>'Etude sur rats (Gymnema + Gliclazide)',
    'long_name'=>'Etude sur rats (Gymnema + Gliclazide)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>564,
    'name'=>'Etude sur rats (Gymnema + Metformine)',
    'long_name'=>'Etude sur rats (Gymnema + Metformine)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>565,
    'name'=>'Etude sur rats (Ail + Glibenclamide)',
    'long_name'=>'Etude sur rats (Ail + Glibenclamide)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>566,
    'name'=>'Etude sur rats (Ail + Metformine)',
    'long_name'=>'Etude sur rats (Ail + Metformine)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>567,
    'name'=>'Etude sur rats (Fenugrec + Glibenclamide))',
    'long_name'=>'Etude sur rats (Fenugrec + Glibenclamide))',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>568,
    'name'=>'Etude sur rats (Melon amer + Metformine)',
    'long_name'=>'Etude sur rats (Melon amer + Metformine)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>569,
    'name'=>'Etude sur rats (Gymnema + Glibenclamide)',
    'long_name'=>'Etude sur rats (Gymnema + Glibenclamide)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>570,
    'name'=>'Etude sur rats (Thé et Metformine)',
    'long_name'=>'Etude sur rats (Thé et Metformine)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>571,
    'name'=>'Etude sur rats (Fenugrec + Glimépiride)',
    'long_name'=>'Etudes sur rats (Fenugrec + Glimépiride)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>572,
    'name'=>'Etude sur rats (Melon amer + Glimépiride)',
    'long_name'=>'Etude sur rats (Melon amer + Glimépiride)',
    'target_type_id'=>6,
    ...
    Target::create( [
    'id'=>573,
    'name'=>'Etude sur rats (Gymnema + Glimépiride)',
    'long_name'=>'Etude sur rats (Gymnema + Glimépiride)',
    'target_type_id'=>6,
    ...
    'id'=>577,
    'name'=>'Dysthyroïdie',
    'long_name'=>'La prise concomitante d\'une plante à effet hypo ou hyperthyroidien avec un médicament ayant le même effet majore le risque d\'hypo ou d\'hyperthyroïdie',
    'target_type_id'=>3,
    'notes'=>'',
    'user_id'=>43,
    'validated'=>1
    ...
    Target::create( [
    'id'=>578,
    'name'=>'Malabsorption digestive',
    'long_name'=>'Risque accru de malabsorption digestive',
    'target_type_id'=>2,
    'notes'=>'',
    'user_id'=>43,
    'validated'=>1
    ...
    Target::create( [
    'id'=>582,
    'name'=>'Case report 4 (Actée à grappes et Hépatotoxicité)',
    'long_name'=>'Case report 4 (Actée à grappes et Hépatotoxicité)',
    'target_type_id'=>1,
    ...
    Target::create( [
        'id'=>584,
        'name'=>'Case report 6 (Actée à grappes et Hépatotoxicité)',
        'long_name'=>'Case report 6 (Actée à grappes et Hépatotoxicité)',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>645,
        'name'=>'Case report 3 (Goji + Warfarine)',
        'long_name'=>'Case report 3 (Goji + Warfarine)',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>646,
        'name'=>'Etude clinique (Melon amer + Metformine + Glibenclamide)',
        'long_name'=>'Etude clinique (Melon amer + Metformine + Glibenclamide)',
        'target_type_id'=>4,
        ...
        Target::create( [
        'id'=>647,
        'name'=>'Case report (Nopal + Metformine + Glipizide)',
        'long_name'=>'Case report (Nopal + Metformine + Glipizide)',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>648,
        'name'=>'Case report (Nopal + Metformine + Glibenclamide)',
        'long_name'=>'Case report (Nopal + Metformine + Glibenclamide',
        'target_type_id'=>1,
        ...
        Target::create( [
        'id'=>649,
        'name'=>'Case report (Nopal + Metformine)',
        'long_name'=>'Case report (Nopal + Metformine)',
        'target_type_id'=>1,
        ...
        Target::create( [
            'id'=>650,
            'name'=>'Etude in vitro (Oignon + Glibenclamide)',
            'long_name'=>'Etude in vitro (Oignon + Glibenclamide)',
            'target_type_id'=>7,
            ...
            Target::create( [
            'id'=>652,
            'name'=>'Etude clinique (Thé + Metformine + Sulfonylurées)',
            'long_name'=>'Etude clinique (Thé + Metformine + Sulfonylurées)',
            'target_type_id'=>4,
            ...
            Target::create( [
            'id'=>590,
            'name'=>'Seuil épileptogène',
            'long_name'=>'Association entre des plantes abaissant le seuil épileptogène et un médicament anti-épileptique est théoriquement déconseilet la phosporylationlée car incidence accrue de crises d\'épilepsies.',
            'target_type_id'=>3,
            'notes'=>'',
            'user_id'=>43,
            'validated'=>1
            ...
            Target::create( [
            'id'=>591,
            'name'=>'Etude clinique (Aloe + Glibenclamide)',
            'long_name'=>'Etude clinique (Aloe + Glibenclamide)',
            'target_type_id'=>4,
            ...
            Target::create( [
            'id'=>593,
            'name'=>'Etude in vitro (Canneberge + Nifédipine)',
            'long_name'=>'Etude in vitro (Canneberge + Nifédipine)',
            'target_type_id'=>7,
            ...
            Target::create( [
            'id'=>594,
            'name'=>'Etude clinique (Andrographis + metformine)',
            'long_name'=>'Etude clinique (Andrographis + metformine)',
            'target_type_id'=>4,
            ...
            'id'=>595,
            'name'=>'Diurèse',
            'long_name'=>'La prise concomitante d\'une plante diurétique avec un médicament diurétique peut théoriquement majorer la diurèse.',
            'target_type_id'=>3,
            'notes'=>'',
            'user_id'=>43,
            'validated'=>1
            ...
            Target::create( [
            'id'=>627,
            'name'=>'Etude clinique (Ail + Metformine)',
            'long_name'=>'Etude clinique (Ail + Metformine)',
            'target_type_id'=>4,
            ...
            Target::create( [
            'id'=>630,
            'name'=>'Etude clinique (Ail + Sulfonylurées)',
            'long_name'=>'Etude clinique (Ail + Sulfonylurées)',
            'target_type_id'=>4,
            ...
            Target::create( [
            'id'=>632,
            'name'=>'Etude sur rats (Cannelier de Chine + Glibenclamide + Metformine)',
            'long_name'=>'Etude sur rats (Cannelier de Chine + Glibenclamide + Metformine)',
            'target_type_id'=>6,
            ...
            'long_name'=>'Dipeptidyl peptidase 4',
            'target_type_id'=>3,
            'notes'=>'',
            'user_id'=>30,
            'validated'=>1
            ...
            Target::create( [
            'id'=>642,
            'name'=>'Etude in vitro (Ginkgo + Glibenclamide)',
            'long_name'=>'Etude in vitro (Ginkgo + Glibenclamide)',
            'target_type_id'=>7,
            ...
            Target::create( [
            'id'=>643,
            'name'=>'Case report (Goji + Warfarine)',
            'long_name'=>'Case report (Goji + Warfarine)',
            'target_type_id'=>1,
            ...
            Target::create( [
            'id'=>644,
            'name'=>'Case report 2 (Goji + Warfarine)',
            'long_name'=>'Case report 2 (Goji + Warfarine)',
            'target_type_id'=>1,
            ...
            Target::create( [
                'id'=>603,
                'name'=>'Case report (Huile de graines de Lin + Acide acétylsalicylique)',
                'long_name'=>'Case report (Huile de graines de Lin + Acide acétylsalicylique)',
                'target_type_id'=>1,
                'notes'=>'Un cas rapporté décrit brièvement des saignements de nez chez un patients prenant de l\'Aspirine et de l\'huile de graines de Lin.',
                'user_id'=>43,
                'validated'=>1
                ] );
